...
printint(int fd, int xx, int base, int sgn)
{
 ...
 646:	8ce50513          	addi	a0,a0,-1842 # f10 <digits>
 64a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 712:	802b8b93          	addi	s7,s7,-2046 # f10 <digits>
...
free(void *ap)
{
 ...
 91a:	61a7b783          	ld	a5,1562(a5) # f30 <freep>
 ...
 948:	00e6ea63          	bltu	a3,a4,95c <free+0x50>
{
 ...
 98a:	5af73523          	sd	a5,1450(a4) # f30 <freep>
}
 98e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9bc:	57853503          	ld	a0,1400(a0) # f30 <freep>
 ...
 9e4:	55090913          	addi	s2,s2,1360 # f30 <freep>
  if(p == (char*)-1)
 9e8:	5afd                	li	s5,-1
 ...
 9f8:	52f73e23          	sd	a5,1340(a4) # f30 <freep>
 9fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a1e:	50a73b23          	sd	a0,1302(a4) # f30 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 b28:	40070713          	addi	a4,a4,1024 # f24 <id>
 b2c:	431c                	lw	a5,0(a4)
