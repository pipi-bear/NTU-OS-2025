...
printint(int fd, int xx, int base, int sgn)
{
 ...
 388:	4b450513          	addi	a0,a0,1204 # 838 <digits>
 38c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 454:	3e8b8b93          	addi	s7,s7,1000 # 838 <digits>
 ...
 594:	2a090913          	addi	s2,s2,672 # 830 <longjmp_1+0x4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 65c:	1f87b783          	ld	a5,504(a5) # 850 <freep>
 ...
 68a:	00e6ea63          	bltu	a3,a4,69e <free+0x50>
{
 ...
 6cc:	18f73423          	sd	a5,392(a4) # 850 <freep>
}
 6d0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	12e90913          	addi	s2,s2,302 # 850 <freep>
  if(p == (char*)-1)
 72a:	5afd                	li	s5,-1
 ...
 760:	0ea73a23          	sd	a0,244(a4) # 850 <freep>
      return (void*)(p + 1);
...
00000000000007ba <setjmp>:
 7ba:	e100                	sd	s0,0(a0)
 7bc:	e504                	sd	s1,8(a0)
 7be:	01253823          	sd	s2,16(a0)
 7c2:	01353c23          	sd	s3,24(a0)
 7c6:	03453023          	sd	s4,32(a0)
 7ca:	03553423          	sd	s5,40(a0)
 7ce:	03653823          	sd	s6,48(a0)
 7d2:	03753c23          	sd	s7,56(a0)
 7d6:	05853023          	sd	s8,64(a0)
 7da:	05953423          	sd	s9,72(a0)
 7de:	05a53823          	sd	s10,80(a0)
 7e2:	05b53c23          	sd	s11,88(a0)
 7e6:	06153023          	sd	ra,96(a0)
 7ea:	06253423          	sd	sp,104(a0)
 7ee:	4501                	li	a0,0
 7f0:	8082                	ret

00000000000007f2 <longjmp>:
 7f2:	6100                	ld	s0,0(a0)
 7f4:	6504                	ld	s1,8(a0)
 7f6:	01053903          	ld	s2,16(a0)
 7fa:	01853983          	ld	s3,24(a0)
 7fe:	02053a03          	ld	s4,32(a0)
 802:	02853a83          	ld	s5,40(a0)
 806:	03053b03          	ld	s6,48(a0)
 80a:	03853b83          	ld	s7,56(a0)
 80e:	04053c03          	ld	s8,64(a0)
 812:	04853c83          	ld	s9,72(a0)
 816:	05053d03          	ld	s10,80(a0)
 81a:	05853d83          	ld	s11,88(a0)
 81e:	06053083          	ld	ra,96(a0)
 822:	06853103          	ld	sp,104(a0)
 826:	c199                	beqz	a1,82c <longjmp_1>
 828:	852e                	mv	a0,a1
 82a:	8082                	ret

000000000000082c <longjmp_1>:
 82c:	4505                	li	a0,1
 82e:	8082                	ret
