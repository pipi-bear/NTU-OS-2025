...
main(int argc, char *argv[])
{
  ...
  14:	85858593          	addi	a1,a1,-1960 # 868 <longjmp_1+0x6>
  18:	4509                	li	a0,2
  ...
  50:	83458593          	addi	a1,a1,-1996 # 880 <longjmp_1+0x1e>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	4e650513          	addi	a0,a0,1254 # 8a0 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	41ab8b93          	addi	s7,s7,1050 # 8a0 <digits>
 ...
 5ca:	2d290913          	addi	s2,s2,722 # 898 <longjmp_1+0x36>
        while(*s != 0){
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x50>
{
 ...
 702:	1af73d23          	sd	a5,442(a4) # 8b8 <freep>
}
 706:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	18853503          	ld	a0,392(a0) # 8b8 <freep>
 ...
 75c:	16090913          	addi	s2,s2,352 # 8b8 <freep>
  if(p == (char*)-1)
 760:	5afd                	li	s5,-1
 762:	a88d                	j	7d4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 764:	00000797          	auipc	a5,0x0
 768:	15c78793          	addi	a5,a5,348 # 8c0 <base>
 76c:	00000717          	auipc	a4,0x0
 770:	14f73623          	sd	a5,332(a4) # 8b8 <freep>
 774:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 796:	12a73323          	sd	a0,294(a4) # 8b8 <freep>
      return (void*)(p + 1);
...
00000000000007f0 <setjmp>:
 7f0:	e100                	sd	s0,0(a0)
 7f2:	e504                	sd	s1,8(a0)
 7f4:	01253823          	sd	s2,16(a0)
 7f8:	01353c23          	sd	s3,24(a0)
 7fc:	03453023          	sd	s4,32(a0)
 800:	03553423          	sd	s5,40(a0)
 804:	03653823          	sd	s6,48(a0)
 808:	03753c23          	sd	s7,56(a0)
 80c:	05853023          	sd	s8,64(a0)
 810:	05953423          	sd	s9,72(a0)
 814:	05a53823          	sd	s10,80(a0)
 818:	05b53c23          	sd	s11,88(a0)
 81c:	06153023          	sd	ra,96(a0)
 820:	06253423          	sd	sp,104(a0)
 824:	4501                	li	a0,0
 826:	8082                	ret

0000000000000828 <longjmp>:
 828:	6100                	ld	s0,0(a0)
 82a:	6504                	ld	s1,8(a0)
 82c:	01053903          	ld	s2,16(a0)
 830:	01853983          	ld	s3,24(a0)
 834:	02053a03          	ld	s4,32(a0)
 838:	02853a83          	ld	s5,40(a0)
 83c:	03053b03          	ld	s6,48(a0)
 840:	03853b83          	ld	s7,56(a0)
 844:	04053c03          	ld	s8,64(a0)
 848:	04853c83          	ld	s9,72(a0)
 84c:	05053d03          	ld	s10,80(a0)
 850:	05853d83          	ld	s11,88(a0)
 854:	06053083          	ld	ra,96(a0)
 858:	06853103          	ld	sp,104(a0)
 85c:	c199                	beqz	a1,862 <longjmp_1>
 85e:	852e                	mv	a0,a1
 860:	8082                	ret

0000000000000862 <longjmp_1>:
 862:	4505                	li	a0,1
 864:	8082                	ret
