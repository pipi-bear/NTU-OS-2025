...
main(int argc, char *argv[])
{
  ...
  1a:	93278793          	addi	a5,a5,-1742 # 948 <longjmp_1+0x3a>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8ec50513          	addi	a0,a0,-1812 # 918 <longjmp_1+0xa>
  ...
  6c:	8c850513          	addi	a0,a0,-1848 # 930 <longjmp_1+0x22>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	88a50513          	addi	a0,a0,-1910 # 940 <longjmp_1+0x32>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	4fa50513          	addi	a0,a0,1274 # 960 <digits>
 46e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 536:	42eb8b93          	addi	s7,s7,1070 # 960 <digits>
 ...
 676:	2e690913          	addi	s2,s2,742 # 958 <longjmp_1+0x4a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73e:	23e7b783          	ld	a5,574(a5) # 978 <freep>
 ...
 76c:	00e6ea63          	bltu	a3,a4,780 <free+0x50>
{
 ...
 7ae:	1cf73723          	sd	a5,462(a4) # 978 <freep>
}
 7b2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7e0:	19c53503          	ld	a0,412(a0) # 978 <freep>
 ...
 808:	17490913          	addi	s2,s2,372 # 978 <freep>
  if(p == (char*)-1)
 80c:	5afd                	li	s5,-1
 80e:	a88d                	j	880 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 810:	00000797          	auipc	a5,0x0
 814:	17078793          	addi	a5,a5,368 # 980 <base>
 818:	00000717          	auipc	a4,0x0
 81c:	16f73023          	sd	a5,352(a4) # 978 <freep>
 820:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 842:	12a73d23          	sd	a0,314(a4) # 978 <freep>
      return (void*)(p + 1);
...
000000000000089c <setjmp>:
 89c:	e100                	sd	s0,0(a0)
 89e:	e504                	sd	s1,8(a0)
 8a0:	01253823          	sd	s2,16(a0)
 8a4:	01353c23          	sd	s3,24(a0)
 8a8:	03453023          	sd	s4,32(a0)
 8ac:	03553423          	sd	s5,40(a0)
 8b0:	03653823          	sd	s6,48(a0)
 8b4:	03753c23          	sd	s7,56(a0)
 8b8:	05853023          	sd	s8,64(a0)
 8bc:	05953423          	sd	s9,72(a0)
 8c0:	05a53823          	sd	s10,80(a0)
 8c4:	05b53c23          	sd	s11,88(a0)
 8c8:	06153023          	sd	ra,96(a0)
 8cc:	06253423          	sd	sp,104(a0)
 8d0:	4501                	li	a0,0
 8d2:	8082                	ret

00000000000008d4 <longjmp>:
 8d4:	6100                	ld	s0,0(a0)
 8d6:	6504                	ld	s1,8(a0)
 8d8:	01053903          	ld	s2,16(a0)
 8dc:	01853983          	ld	s3,24(a0)
 8e0:	02053a03          	ld	s4,32(a0)
 8e4:	02853a83          	ld	s5,40(a0)
 8e8:	03053b03          	ld	s6,48(a0)
 8ec:	03853b83          	ld	s7,56(a0)
 8f0:	04053c03          	ld	s8,64(a0)
 8f4:	04853c83          	ld	s9,72(a0)
 8f8:	05053d03          	ld	s10,80(a0)
 8fc:	05853d83          	ld	s11,88(a0)
 900:	06053083          	ld	ra,96(a0)
 904:	06853103          	ld	sp,104(a0)
 908:	c199                	beqz	a1,90e <longjmp_1>
 90a:	852e                	mv	a0,a1
 90c:	8082                	ret

000000000000090e <longjmp_1>:
 90e:	4505                	li	a0,1
 910:	8082                	ret
