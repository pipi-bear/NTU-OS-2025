...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	35650513          	addi	a0,a0,854 # 13f0 <longjmp_1+0x6>
      a2:	00001097          	auipc	ra,0x1
      a6:	e24080e7          	jalr	-476(ra) # ec6 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	34650513          	addi	a0,a0,838 # 13f0 <longjmp_1+0x6>
      b2:	00001097          	auipc	ra,0x1
      b6:	e1c080e7          	jalr	-484(ra) # ece <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	33c50513          	addi	a0,a0,828 # 13f8 <longjmp_1+0xe>
  ...
  chdir("/");
      ...
      da:	34250513          	addi	a0,a0,834 # 1418 <longjmp_1+0x2e>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	34298993          	addi	s3,s3,834 # 1428 <longjmp_1+0x3e>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	33098993          	addi	s3,s3,816 # 1420 <longjmp_1+0x36>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1231+0x7b>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	32850513          	addi	a0,a0,808 # 1430 <longjmp_1+0x46>
    ...
    if(what == 1){
     ...
     292:	3c258593          	addi	a1,a1,962 # 1650 <longjmp_1+0x266>
     ...
     2b6:	3f650513          	addi	a0,a0,1014 # 16a8 <longjmp_1+0x2be>
     ...
     2d4:	17050513          	addi	a0,a0,368 # 1440 <longjmp_1+0x56>
     ...
     35c:	10850513          	addi	a0,a0,264 # 1460 <longjmp_1+0x76>
     ...
     37e:	0f650513          	addi	a0,a0,246 # 1470 <longjmp_1+0x86>
     ...
     396:	36e58593          	addi	a1,a1,878 # 1700 <buf.1231>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	35658593          	addi	a1,a1,854 # 1700 <buf.1231>
     3b2:	854a                	mv	a0,s2
     ...
     4b4:	04050513          	addi	a0,a0,64 # 14f0 <longjmp_1+0x106>
     ...
     502:	ff250513          	addi	a0,a0,-14 # 14f0 <longjmp_1+0x106>
     ...
     55e:	fae50513          	addi	a0,a0,-82 # 1508 <longjmp_1+0x11e>
     ...
     58a:	f4a50513          	addi	a0,a0,-182 # 14d0 <longjmp_1+0xe6>
     ...
     5ac:	f4850513          	addi	a0,a0,-184 # 14f0 <longjmp_1+0x106>
     ...
     5c6:	f5650513          	addi	a0,a0,-170 # 1518 <longjmp_1+0x12e>
     ...
     614:	ee050513          	addi	a0,a0,-288 # 14f0 <longjmp_1+0x106>
     ...
     670:	ec450513          	addi	a0,a0,-316 # 1530 <longjmp_1+0x146>
     ...
     69c:	eb058593          	addi	a1,a1,-336 # 1548 <longjmp_1+0x15e>
     ...
     79e:	d5650513          	addi	a0,a0,-682 # 14f0 <longjmp_1+0x106>
     ...
     7b8:	ddc50513          	addi	a0,a0,-548 # 1590 <longjmp_1+0x1a6>
     7bc:	00000097          	auipc	ra,0x0
     7c0:	6f2080e7          	jalr	1778(ra) # eae <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7c4:	20200593          	li	a1,514
     7c8:	00001517          	auipc	a0,0x1
     7cc:	dc850513          	addi	a0,a0,-568 # 1590 <longjmp_1+0x1a6>
     ...
     7e4:	d6858593          	addi	a1,a1,-664 # 1548 <longjmp_1+0x15e>
     ...
     82a:	d6a50513          	addi	a0,a0,-662 # 1590 <longjmp_1+0x1a6>
     82e:	00000097          	auipc	ra,0x0
     832:	680080e7          	jalr	1664(ra) # eae <unlink>
     836:	b0ed                	j	120 <go+0xa8>
        printf("grind: create c failed\n");
     838:	00001517          	auipc	a0,0x1
     83c:	d6050513          	addi	a0,a0,-672 # 1598 <longjmp_1+0x1ae>
     ...
     856:	d5e50513          	addi	a0,a0,-674 # 15b0 <longjmp_1+0x1c6>
     ...
     870:	d5c50513          	addi	a0,a0,-676 # 15c8 <longjmp_1+0x1de>
     ...
     88c:	d5850513          	addi	a0,a0,-680 # 15e0 <longjmp_1+0x1f6>
     ...
     8a6:	d6650513          	addi	a0,a0,-666 # 1608 <longjmp_1+0x21e>
     ...
     8c0:	c7458593          	addi	a1,a1,-908 # 1530 <longjmp_1+0x146>
     8c4:	4509                	li	a0,2
     ...
     8dc:	c5858593          	addi	a1,a1,-936 # 1530 <longjmp_1+0x146>
     8e0:	4509                	li	a0,2
     ...
     938:	cfc58593          	addi	a1,a1,-772 # 1630 <longjmp_1+0x246>
     93c:	4509                	li	a0,2
     ...
     9ac:	b4858593          	addi	a1,a1,-1208 # 14f0 <longjmp_1+0x106>
     9b0:	4509                	li	a0,2
     ...
     9f8:	c3c58593          	addi	a1,a1,-964 # 1630 <longjmp_1+0x246>
     9fc:	4509                	li	a0,2
     ...
     a3c:	bf858593          	addi	a1,a1,-1032 # 1630 <longjmp_1+0x246>
     a40:	4509                	li	a0,2
     ...
     aa4:	a5058593          	addi	a1,a1,-1456 # 14f0 <longjmp_1+0x106>
     aa8:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	a0850513          	addi	a0,a0,-1528 # 14d0 <longjmp_1+0xe6>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3de080e7          	jalr	990(ra) # eae <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	9a850513          	addi	a0,a0,-1624 # 1480 <longjmp_1+0x96>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     afe:	bef73b23          	sd	a5,-1034(a4) # 16f0 <rand_next>
    go(0);
     b02:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b10:	9e450513          	addi	a0,a0,-1564 # 14f0 <longjmp_1+0x106>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b36:	6789                	lui	a5,0x2
     b38:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0x111>
     b3c:	00001717          	auipc	a4,0x1
     b40:	baf73a23          	sd	a5,-1100(a4) # 16f0 <rand_next>
    go(1);
     b44:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b52:	9a250513          	addi	a0,a0,-1630 # 14f0 <longjmp_1+0x106>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f46:	79650513          	addi	a0,a0,1942 # 16d8 <digits>
     f4a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1012:	6cab8b93          	addi	s7,s7,1738 # 16d8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1152:	58290913          	addi	s2,s2,1410 # 16d0 <longjmp_1+0x2e6>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    121a:	4e27b783          	ld	a5,1250(a5) # 16f8 <freep>
    ...
    1248:	00e6ea63          	bltu	a3,a4,125c <free+0x50>
{
  ...
  freep = p;
    ...
    128a:	46f73923          	sd	a5,1138(a4) # 16f8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12bc:	44053503          	ld	a0,1088(a0) # 16f8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12e4:	41890913          	addi	s2,s2,1048 # 16f8 <freep>
  if(p == (char*)-1)
    12e8:	5afd                	li	s5,-1
    12ea:	a88d                	j	135c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12ec:	00000797          	auipc	a5,0x0
    12f0:	7fc78793          	addi	a5,a5,2044 # 1ae8 <base>
    12f4:	00000717          	auipc	a4,0x0
    12f8:	40f73223          	sd	a5,1028(a4) # 16f8 <freep>
    ...
    131e:	3ca73f23          	sd	a0,990(a4) # 16f8 <freep>
      return (void*)(p + 1);
...
0000000000001378 <setjmp>:
    1378:	e100                	sd	s0,0(a0)
    137a:	e504                	sd	s1,8(a0)
    137c:	01253823          	sd	s2,16(a0)
    1380:	01353c23          	sd	s3,24(a0)
    1384:	03453023          	sd	s4,32(a0)
    1388:	03553423          	sd	s5,40(a0)
    138c:	03653823          	sd	s6,48(a0)
    1390:	03753c23          	sd	s7,56(a0)
    1394:	05853023          	sd	s8,64(a0)
    1398:	05953423          	sd	s9,72(a0)
    139c:	05a53823          	sd	s10,80(a0)
    13a0:	05b53c23          	sd	s11,88(a0)
    13a4:	06153023          	sd	ra,96(a0)
    13a8:	06253423          	sd	sp,104(a0)
    13ac:	4501                	li	a0,0
    13ae:	8082                	ret

00000000000013b0 <longjmp>:
    13b0:	6100                	ld	s0,0(a0)
    13b2:	6504                	ld	s1,8(a0)
    13b4:	01053903          	ld	s2,16(a0)
    13b8:	01853983          	ld	s3,24(a0)
    13bc:	02053a03          	ld	s4,32(a0)
    13c0:	02853a83          	ld	s5,40(a0)
    13c4:	03053b03          	ld	s6,48(a0)
    13c8:	03853b83          	ld	s7,56(a0)
    13cc:	04053c03          	ld	s8,64(a0)
    13d0:	04853c83          	ld	s9,72(a0)
    13d4:	05053d03          	ld	s10,80(a0)
    13d8:	05853d83          	ld	s11,88(a0)
    13dc:	06053083          	ld	ra,96(a0)
    13e0:	06853103          	ld	sp,104(a0)
    13e4:	c199                	beqz	a1,13ea <longjmp_1>
    13e6:	852e                	mv	a0,a1
    13e8:	8082                	ret

00000000000013ea <longjmp_1>:
    13ea:	4505                	li	a0,1
    13ec:	8082                	ret
