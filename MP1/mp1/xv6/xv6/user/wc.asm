...
wc(int fd, char *name)
{
  ...
  3c:	968a0a13          	addi	s4,s4,-1688 # 9a0 <longjmp_1+0x8>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	90250513          	addi	a0,a0,-1790 # 9b8 <longjmp_1+0x20>
  ...
  e8:	8c450513          	addi	a0,a0,-1852 # 9a8 <longjmp_1+0x10>
...
main(int argc, char *argv[])
{
 ...
 162:	86a58593          	addi	a1,a1,-1942 # 9c8 <longjmp_1+0x30>
 166:	4501                	li	a0,0
 ...
 180:	85450513          	addi	a0,a0,-1964 # 9d0 <longjmp_1+0x38>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4f4:	50050513          	addi	a0,a0,1280 # 9f0 <digits>
 4f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5c0:	434b8b93          	addi	s7,s7,1076 # 9f0 <digits>
 ...
 700:	2ec90913          	addi	s2,s2,748 # 9e8 <longjmp_1+0x50>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c8:	2447b783          	ld	a5,580(a5) # a08 <freep>
...
malloc(uint nbytes)
{
 ...
 89e:	37678793          	addi	a5,a5,886 # c10 <base>
 8a2:	00000717          	auipc	a4,0x0
 8a6:	16f73323          	sd	a5,358(a4) # a08 <freep>
 8aa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8cc:	14a73023          	sd	a0,320(a4) # a08 <freep>
      return (void*)(p + 1);
...
0000000000000926 <setjmp>:
 926:	e100                	sd	s0,0(a0)
 928:	e504                	sd	s1,8(a0)
 92a:	01253823          	sd	s2,16(a0)
 92e:	01353c23          	sd	s3,24(a0)
 932:	03453023          	sd	s4,32(a0)
 936:	03553423          	sd	s5,40(a0)
 93a:	03653823          	sd	s6,48(a0)
 93e:	03753c23          	sd	s7,56(a0)
 942:	05853023          	sd	s8,64(a0)
 946:	05953423          	sd	s9,72(a0)
 94a:	05a53823          	sd	s10,80(a0)
 94e:	05b53c23          	sd	s11,88(a0)
 952:	06153023          	sd	ra,96(a0)
 956:	06253423          	sd	sp,104(a0)
 95a:	4501                	li	a0,0
 95c:	8082                	ret

000000000000095e <longjmp>:
 95e:	6100                	ld	s0,0(a0)
 960:	6504                	ld	s1,8(a0)
 962:	01053903          	ld	s2,16(a0)
 966:	01853983          	ld	s3,24(a0)
 96a:	02053a03          	ld	s4,32(a0)
 96e:	02853a83          	ld	s5,40(a0)
 972:	03053b03          	ld	s6,48(a0)
 976:	03853b83          	ld	s7,56(a0)
 97a:	04053c03          	ld	s8,64(a0)
 97e:	04853c83          	ld	s9,72(a0)
 982:	05053d03          	ld	s10,80(a0)
 986:	05853d83          	ld	s11,88(a0)
 98a:	06053083          	ld	ra,96(a0)
 98e:	06853103          	ld	sp,104(a0)
 992:	c199                	beqz	a1,998 <longjmp_1>
 994:	852e                	mv	a0,a1
 996:	8082                	ret

0000000000000998 <longjmp_1>:
 998:	4505                	li	a0,1
 99a:	8082                	ret
