...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	e8a50513          	addi	a0,a0,-374 # 5ec8 <longjmp_1+0x326>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	3b078793          	addi	a5,a5,944 # 9408 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	ab868693          	addi	a3,a3,-1352 # bb18 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	e6850513          	addi	a0,a0,-408 # 5ee8 <longjmp_1+0x346>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	e5850513          	addi	a0,a0,-424 # 5f00 <longjmp_1+0x35e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	e5a50513          	addi	a0,a0,-422 # 5f20 <longjmp_1+0x37e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	e2250513          	addi	a0,a0,-478 # 5f08 <longjmp_1+0x366>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	e2e50513          	addi	a0,a0,-466 # 5f30 <longjmp_1+0x38e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	e2c50513          	addi	a0,a0,-468 # 5f58 <longjmp_1+0x3b6>
     134:	00005097          	auipc	ra,0x5
     138:	532080e7          	jalr	1330(ra) # 5666 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	e1850513          	addi	a0,a0,-488 # 5f58 <longjmp_1+0x3b6>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	e1458593          	addi	a1,a1,-492 # 5f68 <longjmp_1+0x3c6>
     15c:	00005097          	auipc	ra,0x5
     160:	4da080e7          	jalr	1242(ra) # 5636 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	df050513          	addi	a0,a0,-528 # 5f58 <longjmp_1+0x3b6>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	df458593          	addi	a1,a1,-524 # 5f70 <longjmp_1+0x3ce>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	dc450513          	addi	a0,a0,-572 # 5f58 <longjmp_1+0x3b6>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	dae50513          	addi	a0,a0,-594 # 5f78 <longjmp_1+0x3d6>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	afc50513          	addi	a0,a0,-1284 # 5d78 <longjmp_1+0x1d6>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	ae8a8a93          	addi	s5,s5,-1304 # 5d78 <longjmp_1+0x1d6>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	880a0a13          	addi	s4,s4,-1920 # bb18 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	c8e50513          	addi	a0,a0,-882 # 5fa0 <longjmp_1+0x3fe>
     ...
     33a:	c8a50513          	addi	a0,a0,-886 # 5fc0 <longjmp_1+0x41e>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	c66a0a13          	addi	s4,s4,-922 # 5fd8 <longjmp_1+0x436>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	bc250513          	addi	a0,a0,-1086 # 5fe0 <longjmp_1+0x43e>
     ...
     440:	bbc50513          	addi	a0,a0,-1092 # 5ff8 <longjmp_1+0x456>
     ...
     45e:	bce50513          	addi	a0,a0,-1074 # 6028 <longjmp_1+0x486>
     ...
     478:	be450513          	addi	a0,a0,-1052 # 6058 <longjmp_1+0x4b6>
     ...
     496:	bd650513          	addi	a0,a0,-1066 # 6068 <longjmp_1+0x4c6>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	bc8a0a13          	addi	s4,s4,-1080 # 6098 <longjmp_1+0x4f6>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	a98a8a93          	addi	s5,s5,-1384 # 5f70 <longjmp_1+0x3ce>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	b2250513          	addi	a0,a0,-1246 # 60a0 <longjmp_1+0x4fe>
     ...
     5a0:	b1c50513          	addi	a0,a0,-1252 # 60b8 <longjmp_1+0x516>
     ...
     5ba:	aa250513          	addi	a0,a0,-1374 # 6058 <longjmp_1+0x4b6>
     ...
     5d4:	b1850513          	addi	a0,a0,-1256 # 60e8 <longjmp_1+0x546>
     ...
     5f2:	b1250513          	addi	a0,a0,-1262 # 6100 <longjmp_1+0x55e>
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	92458593          	addi	a1,a1,-1756 # 5f68 <longjmp_1+0x3c6>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	8f850513          	addi	a0,a0,-1800 # 5f58 <longjmp_1+0x3b6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	8cc50513          	addi	a0,a0,-1844 # 5f58 <longjmp_1+0x3b6>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	8b850513          	addi	a0,a0,-1864 # 5f58 <longjmp_1+0x3b6>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	ab258593          	addi	a1,a1,-1358 # 6190 <longjmp_1+0x5ee>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	83850513          	addi	a0,a0,-1992 # 5f58 <longjmp_1+0x3b6>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	9cc50513          	addi	a0,a0,-1588 # 6130 <longjmp_1+0x58e>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	9d050513          	addi	a0,a0,-1584 # 6150 <longjmp_1+0x5ae>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     798:	9cc50513          	addi	a0,a0,-1588 # 6160 <longjmp_1+0x5be>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	9d050513          	addi	a0,a0,-1584 # 6180 <longjmp_1+0x5de>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c8:	99c50513          	addi	a0,a0,-1636 # 6160 <longjmp_1+0x5be>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	9b650513          	addi	a0,a0,-1610 # 6198 <longjmp_1+0x5f6>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	9b850513          	addi	a0,a0,-1608 # 61b8 <longjmp_1+0x616>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	9a450513          	addi	a0,a0,-1628 # 61d8 <longjmp_1+0x636>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	9b498993          	addi	s3,s3,-1612 # 6200 <longjmp_1+0x65e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	9e4a8a93          	addi	s5,s5,-1564 # 6238 <longjmp_1+0x696>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	93e50513          	addi	a0,a0,-1730 # 61d8 <longjmp_1+0x636>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	26458593          	addi	a1,a1,612 # bb18 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	90250513          	addi	a0,a0,-1790 # 61d8 <longjmp_1+0x636>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	8e050513          	addi	a0,a0,-1824 # 61e0 <longjmp_1+0x63e>
    ...
    exit(1);
     ...
     922:	8f250513          	addi	a0,a0,-1806 # 6210 <longjmp_1+0x66e>
     ...
     940:	90c50513          	addi	a0,a0,-1780 # 6248 <longjmp_1+0x6a6>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	91850513          	addi	a0,a0,-1768 # 6270 <longjmp_1+0x6ce>
    ...
    printf("%s: read failed\n", s);
     ...
     978:	91c50513          	addi	a0,a0,-1764 # 6290 <longjmp_1+0x6ee>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	91850513          	addi	a0,a0,-1768 # 62a8 <longjmp_1+0x706>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	90650513          	addi	a0,a0,-1786 # 62c8 <longjmp_1+0x726>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	14290913          	addi	s2,s2,322 # bb18 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	8b450513          	addi	a0,a0,-1868 # 62c8 <longjmp_1+0x726>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	0f090913          	addi	s2,s2,240 # bb18 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	87450513          	addi	a0,a0,-1932 # 62d0 <longjmp_1+0x72e>
    ...
    exit(1);
     ...
     a7e:	87650513          	addi	a0,a0,-1930 # 62f0 <longjmp_1+0x74e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	88250513          	addi	a0,a0,-1918 # 6318 <longjmp_1+0x776>
  ...
  if(unlink("big") < 0){
     ...
     ac6:	80650513          	addi	a0,a0,-2042 # 62c8 <longjmp_1+0x726>
     ...
     af2:	84a50513          	addi	a0,a0,-1974 # 6338 <longjmp_1+0x796>
     ...
     b10:	85450513          	addi	a0,a0,-1964 # 6360 <longjmp_1+0x7be>
     ...
     b2e:	84e50513          	addi	a0,a0,-1970 # 6378 <longjmp_1+0x7d6>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	85a50513          	addi	a0,a0,-1958 # 63a0 <longjmp_1+0x7fe>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	19450513          	addi	a0,a0,404 # 5d08 <longjmp_1+0x166>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	84c58593          	addi	a1,a1,-1972 # 63d8 <longjmp_1+0x836>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	16050513          	addi	a0,a0,352 # 5d08 <longjmp_1+0x166>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	14a50513          	addi	a0,a0,330 # 5d08 <longjmp_1+0x166>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	13450513          	addi	a0,a0,308 # 5d08 <longjmp_1+0x166>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	83858593          	addi	a1,a1,-1992 # 6420 <longjmp_1+0x87e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	f1458593          	addi	a1,a1,-236 # bb18 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	0b850513          	addi	a0,a0,184 # 5d08 <longjmp_1+0x166>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	74850513          	addi	a0,a0,1864 # 63b8 <longjmp_1+0x816>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	75450513          	addi	a0,a0,1876 # 63e0 <longjmp_1+0x83e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	75850513          	addi	a0,a0,1880 # 6400 <longjmp_1+0x85e>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	76450513          	addi	a0,a0,1892 # 6428 <longjmp_1+0x886>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	76850513          	addi	a0,a0,1896 # 6448 <longjmp_1+0x8a6>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	76c50513          	addi	a0,a0,1900 # 6468 <longjmp_1+0x8c6>
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	67858593          	addi	a1,a1,1656 # 63d8 <longjmp_1+0x836>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	71058593          	addi	a1,a1,1808 # 6490 <longjmp_1+0x8ee>
     d88:	00005517          	auipc	a0,0x5
     d8c:	70050513          	addi	a0,a0,1792 # 6488 <longjmp_1+0x8e6>
  ...
  unlink("lf1");
     ...
     da0:	6ec50513          	addi	a0,a0,1772 # 6488 <longjmp_1+0x8e6>
     da4:	00005097          	auipc	ra,0x5
     da8:	8c2080e7          	jalr	-1854(ra) # 5666 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	6da50513          	addi	a0,a0,1754 # 6488 <longjmp_1+0x8e6>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	6cc50513          	addi	a0,a0,1740 # 6490 <longjmp_1+0x8ee>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	d3c58593          	addi	a1,a1,-708 # bb18 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	69458593          	addi	a1,a1,1684 # 6490 <longjmp_1+0x8ee>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	67e50513          	addi	a0,a0,1662 # 6490 <longjmp_1+0x8ee>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	84c080e7          	jalr	-1972(ra) # 5666 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	66658593          	addi	a1,a1,1638 # 6488 <longjmp_1+0x8e6>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	66650513          	addi	a0,a0,1638 # 6490 <longjmp_1+0x8ee>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	64a58593          	addi	a1,a1,1610 # 6488 <longjmp_1+0x8e6>
     e46:	00005517          	auipc	a0,0x5
     e4a:	75250513          	addi	a0,a0,1874 # 6598 <longjmp_1+0x9f6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	63050513          	addi	a0,a0,1584 # 6498 <longjmp_1+0x8f6>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	62c50513          	addi	a0,a0,1580 # 64b0 <longjmp_1+0x90e>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	62850513          	addi	a0,a0,1576 # 64c8 <longjmp_1+0x926>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	62c50513          	addi	a0,a0,1580 # 64e8 <longjmp_1+0x946>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	64050513          	addi	a0,a0,1600 # 6518 <longjmp_1+0x976>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	63c50513          	addi	a0,a0,1596 # 6530 <longjmp_1+0x98e>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	63850513          	addi	a0,a0,1592 # 6548 <longjmp_1+0x9a6>
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	64450513          	addi	a0,a0,1604 # 6570 <longjmp_1+0x9ce>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	65850513          	addi	a0,a0,1624 # 65a0 <longjmp_1+0x9fe>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	612a0a13          	addi	s4,s4,1554 # 65c0 <longjmp_1+0xa1e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	5c050513          	addi	a0,a0,1472 # 65c0 <longjmp_1+0xa1e>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	55850513          	addi	a0,a0,1368 # 65c8 <longjmp_1+0xa26>
    ...
    1094:	55850513          	addi	a0,a0,1368 # 65e8 <longjmp_1+0xa46>
    ...
    10b0:	55c50513          	addi	a0,a0,1372 # 6608 <longjmp_1+0xa66>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	54a98993          	addi	s3,s3,1354 # 6628 <longjmp_1+0xa86>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	51e50513          	addi	a0,a0,1310 # 6638 <longjmp_1+0xa96>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	1a64b483          	ld	s1,422(s1) # 82e8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x838>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	d7a98993          	addi	s3,s3,-646 # 5f00 <longjmp_1+0x35e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	5f878793          	addi	a5,a5,1528 # 7808 <longjmp_1+0x1c66>
  ...
  if(pid == 0){
    ...
    124a:	1ba78793          	addi	a5,a5,442 # 8400 <big.1264>
    124e:	00008697          	auipc	a3,0x8
    1252:	1b268693          	addi	a3,a3,434 # 9400 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    1268:	18078e23          	sb	zero,412(a5) # 9400 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	c8c78793          	addi	a5,a5,-884 # 7ef8 <longjmp_1+0x2356>
    ...
    1294:	c7050513          	addi	a0,a0,-912 # 5f00 <longjmp_1+0x35e>
    ...
    12ac:	43850513          	addi	a0,a0,1080 # 66e0 <longjmp_1+0xb3e>
    ...
    12cc:	39050513          	addi	a0,a0,912 # 6658 <longjmp_1+0xab6>
    ...
    12ec:	39050513          	addi	a0,a0,912 # 6678 <longjmp_1+0xad6>
    ...
    130e:	38e50513          	addi	a0,a0,910 # 6698 <longjmp_1+0xaf6>
    ...
    132e:	39650513          	addi	a0,a0,918 # 66c0 <longjmp_1+0xb1e>
    ...
    1348:	7fc50513          	addi	a0,a0,2044 # 6b40 <longjmp_1+0xf9e>
  ...
  if(st != 747){
    ...
    1392:	37a50513          	addi	a0,a0,890 # 6708 <longjmp_1+0xb66>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	b9850513          	addi	a0,a0,-1128 # 5f58 <longjmp_1+0x3b6>
  ...
  if(pid == 0){
    ...
    13ee:	b6ea0a13          	addi	s4,s4,-1170 # 5f58 <longjmp_1+0x3b6>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	376a8a93          	addi	s5,s5,886 # 6768 <longjmp_1+0xbc6>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	2d650513          	addi	a0,a0,726 # 6738 <longjmp_1+0xb96>
    ...
    1482:	2d250513          	addi	a0,a0,722 # 6750 <longjmp_1+0xbae>
    ...
    14a0:	2dc50513          	addi	a0,a0,732 # 6778 <longjmp_1+0xbd6>
    ...
    14be:	a9ea0a13          	addi	s4,s4,-1378 # 5f58 <longjmp_1+0x3b6>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	2d6a8a93          	addi	s5,s5,726 # 6798 <longjmp_1+0xbf6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	a4c50513          	addi	a0,a0,-1460 # 5f58 <longjmp_1+0x3b6>
  ...
  exit(xstatus);
    ...
    152e:	22650513          	addi	a0,a0,550 # 6750 <longjmp_1+0xbae>
    ...
    154c:	25850513          	addi	a0,a0,600 # 67a0 <longjmp_1+0xbfe>
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	99078793          	addi	a5,a5,-1648 # 5f00 <longjmp_1+0x35e>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	24478793          	addi	a5,a5,580 # 67c0 <longjmp_1+0xc1e>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	23c50513          	addi	a0,a0,572 # 67c8 <longjmp_1+0xc26>
  ...
  if(pid == 0) {
    ...
    15be:	20e50513          	addi	a0,a0,526 # 67c8 <longjmp_1+0xc26>
    ...
    15da:	21250513          	addi	a0,a0,530 # 67e8 <longjmp_1+0xc46>
    ...
    15f6:	14650513          	addi	a0,a0,326 # 6738 <longjmp_1+0xb96>
    ...
    1612:	1c250513          	addi	a0,a0,450 # 67d0 <longjmp_1+0xc2e>
    ...
    1630:	8d450513          	addi	a0,a0,-1836 # 5f00 <longjmp_1+0x35e>
  ...
  if(xstatus != 0)
    ...
    1664:	19850513          	addi	a0,a0,408 # 67f8 <longjmp_1+0xc56>
    ...
    1680:	19450513          	addi	a0,a0,404 # 6810 <longjmp_1+0xc6e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1694:	13850513          	addi	a0,a0,312 # 67c8 <longjmp_1+0xc26>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	bd650513          	addi	a0,a0,-1066 # 6290 <longjmp_1+0x6ee>
    ...
    16da:	07a50513          	addi	a0,a0,122 # 6750 <longjmp_1+0xbae>
  ...
  unlink("echo-ok");
    ...
    16f4:	0d850513          	addi	a0,a0,216 # 67c8 <longjmp_1+0xc26>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	10e50513          	addi	a0,a0,270 # 6828 <longjmp_1+0xc86>
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	392a8a93          	addi	s5,s5,914 # bb18 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	37470713          	addi	a4,a4,884 # bb18 <buf>
    ...
    17e0:	06450513          	addi	a0,a0,100 # 6840 <longjmp_1+0xc9e>
    ...
    1806:	316b0b13          	addi	s6,s6,790 # bb18 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	ff650513          	addi	a0,a0,-10 # 6858 <longjmp_1+0xcb6>
    ...
    1882:	ff250513          	addi	a0,a0,-14 # 6870 <longjmp_1+0xcce>
    ...
    18b4:	fd850513          	addi	a0,a0,-40 # 6888 <longjmp_1+0xce6>
    ...
    18f4:	fb850513          	addi	a0,a0,-72 # 68a8 <longjmp_1+0xd06>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	dd650513          	addi	a0,a0,-554 # 6738 <longjmp_1+0xb96>
    ...
    1982:	f4250513          	addi	a0,a0,-190 # 68c0 <longjmp_1+0xd1e>
    ...
    199e:	f3e50513          	addi	a0,a0,-194 # 68d8 <longjmp_1+0xd36>
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	d2650513          	addi	a0,a0,-730 # 6738 <longjmp_1+0xb96>
    ...
    1a3a:	d0250513          	addi	a0,a0,-766 # 6738 <longjmp_1+0xb96>
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	e4850513          	addi	a0,a0,-440 # 68f8 <longjmp_1+0xd56>
    ...
    1ac6:	b54080e7          	jalr	-1196(ra) # 5616 <exit>
{
    ...
    1b0c:	e0050513          	addi	a0,a0,-512 # 6908 <longjmp_1+0xd66>
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	fea50513          	addi	a0,a0,-22 # 6b40 <longjmp_1+0xf9e>
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	f4c50513          	addi	a0,a0,-180 # 6b40 <longjmp_1+0xf9e>
    ...
    1c24:	bb050513          	addi	a0,a0,-1104 # 67d0 <longjmp_1+0xc2e>
    ...
    1c96:	c9650513          	addi	a0,a0,-874 # 6928 <longjmp_1+0xd86>
    ...
    1cca:	c7a50513          	addi	a0,a0,-902 # 6940 <longjmp_1+0xd9e>
    ...
    1d30:	c3c50513          	addi	a0,a0,-964 # 6968 <longjmp_1+0xdc6>
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	1a450513          	addi	a0,a0,420 # 5f70 <longjmp_1+0x3ce>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	168a8a93          	addi	s5,s5,360 # 5f70 <longjmp_1+0x3ce>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	b80b8b93          	addi	s7,s7,-1152 # 6990 <longjmp_1+0xdee>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	91c50513          	addi	a0,a0,-1764 # 6738 <longjmp_1+0xb96>
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	c3650513          	addi	a0,a0,-970 # 6b40 <longjmp_1+0xf9e>
    ...
    1f4a:	bd2b8b93          	addi	s7,s7,-1070 # bb18 <buf>
    ...
    1fbe:	9de50513          	addi	a0,a0,-1570 # 6998 <longjmp_1+0xdf6>
    ...
    1fde:	fe650513          	addi	a0,a0,-26 # 5fc0 <longjmp_1+0x41e>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	9a050513          	addi	a0,a0,-1632 # 69c8 <longjmp_1+0xe26>
  ...
  if(wait(0) != -1){
    ...
    208e:	92650513          	addi	a0,a0,-1754 # 69b0 <longjmp_1+0xe0e>
    ...
    20aa:	94a50513          	addi	a0,a0,-1718 # 69f0 <longjmp_1+0xe4e>
    ...
    20c6:	94650513          	addi	a0,a0,-1722 # 6a08 <longjmp_1+0xe66>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x838>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e958>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	5f650513          	addi	a0,a0,1526 # 6738 <longjmp_1+0xb96>
    ...
    2168:	8bc50513          	addi	a0,a0,-1860 # 6a20 <longjmp_1+0xe7e>
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	8ac50513          	addi	a0,a0,-1876 # 6a40 <longjmp_1+0xe9e>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	87a50513          	addi	a0,a0,-1926 # 6a40 <longjmp_1+0xe9e>
  ...
  close(fd);
    ...
    21f0:	11478793          	addi	a5,a5,276 # 8300 <args.1834>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	20468693          	addi	a3,a3,516 # 83f8 <args.1834+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00005717          	auipc	a4,0x5
    2200:	85470713          	addi	a4,a4,-1964 # 6a50 <longjmp_1+0xeae>
    ...
    2254:	8e050513          	addi	a0,a0,-1824 # 6b30 <longjmp_1+0xf8e>
    ...
    2278:	8dc50513          	addi	a0,a0,-1828 # 6b50 <longjmp_1+0xfae>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff04d8>
    22d0:	85a6                	mv	a1,s1
    22d2:	00005517          	auipc	a0,0x5
    22d6:	89e50513          	addi	a0,a0,-1890 # 6b70 <longjmp_1+0xfce>
    ...
    22f2:	44a50513          	addi	a0,a0,1098 # 6738 <longjmp_1+0xb96>
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	48078793          	addi	a5,a5,1152 # 7808 <longjmp_1+0x1c66>
  ...
  if(ret != -1){
    ...
    23ce:	7ce50513          	addi	a0,a0,1998 # 6b98 <longjmp_1+0xff6>
    ...
    23ec:	27050513          	addi	a0,a0,624 # 6658 <longjmp_1+0xab6>
    ...
    240a:	27250513          	addi	a0,a0,626 # 6678 <longjmp_1+0xad6>
    ...
    242a:	27250513          	addi	a0,a0,626 # 6698 <longjmp_1+0xaf6>
    ...
    2448:	27c50513          	addi	a0,a0,636 # 66c0 <longjmp_1+0xb1e>
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	79050513          	addi	a0,a0,1936 # 5c20 <longjmp_1+0x7e>
  ...
  if(n >= 0){
    ...
    24c6:	72e50513          	addi	a0,a0,1838 # 6bf0 <longjmp_1+0x104e>
    ...
    24e0:	6c450513          	addi	a0,a0,1732 # 6ba0 <longjmp_1+0xffe>
    ...
    24fa:	6c250513          	addi	a0,a0,1730 # 6bb8 <longjmp_1+0x1016>
    ...
    2514:	6c850513          	addi	a0,a0,1736 # 6bd8 <longjmp_1+0x1036>
  ...
  unlink("rwsbrk");
    ...
    2538:	6ec50513          	addi	a0,a0,1772 # 5c20 <longjmp_1+0x7e>
    253c:	00003097          	auipc	ra,0x3
    2540:	12a080e7          	jalr	298(ra) # 5666 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	b5250513          	addi	a0,a0,-1198 # 6098 <longjmp_1+0x4f6>
  ...
  if(n >= 0){
    ...
    2574:	6b050513          	addi	a0,a0,1712 # 6c20 <longjmp_1+0x107e>
    ...
    258e:	64e50513          	addi	a0,a0,1614 # 6bd8 <longjmp_1+0x1036>
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    25f6:	6705                	lui	a4,0x1
      *b = 99;
    25f8:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff14d8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2610:	63c50513          	addi	a0,a0,1596 # 6c48 <longjmp_1+0x10a6>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2664:	60850513          	addi	a0,a0,1544 # 6c68 <longjmp_1+0x10c6>
  ...
  if(c != a + 1){
    ...
    26c6:	60650513          	addi	a0,a0,1542 # 6cc8 <longjmp_1+0x1126>
    ...
    26e6:	5a650513          	addi	a0,a0,1446 # 6c88 <longjmp_1+0x10e6>
    ...
    2702:	5aa50513          	addi	a0,a0,1450 # 6ca8 <longjmp_1+0x1106>
...
000000000000273e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    27a0:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f14d7>
  a = sbrk(0);
    27a4:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2804:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f14d7>
  ...
  if(c != a){
    ...
    284c:	4a050513          	addi	a0,a0,1184 # 6ce8 <longjmp_1+0x1146>
    ...
    2868:	4cc50513          	addi	a0,a0,1228 # 6d30 <longjmp_1+0x118e>
    ...
    2888:	4cc50513          	addi	a0,a0,1228 # 6d50 <longjmp_1+0x11ae>
    ...
    28a8:	4ec50513          	addi	a0,a0,1260 # 6d90 <longjmp_1+0x11ee>
    ...
    28c4:	50050513          	addi	a0,a0,1280 # 6dc0 <longjmp_1+0x121e>
    ...
    28e4:	51850513          	addi	a0,a0,1304 # 6df8 <longjmp_1+0x1256>
...
00000000000028fa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291e:	50650513          	addi	a0,a0,1286 # 6e20 <longjmp_1+0x127e>
    2922:	00003097          	auipc	ra,0x3
    2926:	d34080e7          	jalr	-716(ra) # 5656 <open>
    292a:	84aa                	mv	s1,a0
  unlink("sbrk");
    292c:	00004517          	auipc	a0,0x4
    2930:	4f450513          	addi	a0,a0,1268 # 6e20 <longjmp_1+0x127e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2984:	4a850513          	addi	a0,a0,1192 # 6e28 <longjmp_1+0x1286>
    ...
    29a0:	4a450513          	addi	a0,a0,1188 # 6e40 <longjmp_1+0x129e>
    ...
    29bc:	e8850513          	addi	a0,a0,-376 # 6840 <longjmp_1+0xc9e>
...
00000000000029d2 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e6:	47650513          	addi	a0,a0,1142 # 6e58 <longjmp_1+0x12b6>
  ...
  close(fd);
    ...
    2a2e:	d2650513          	addi	a0,a0,-730 # 6750 <longjmp_1+0xbae>
...
0000000000002a44 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7c:	0c850513          	addi	a0,a0,200 # 6b40 <longjmp_1+0xf9e>
  ...
  if(pid == 0){
    ...
    2ad2:	07250513          	addi	a0,a0,114 # 6b40 <longjmp_1+0xf9e>
  ...
  if(pid == 0){
    ...
    2b32:	01250513          	addi	a0,a0,18 # 6b40 <longjmp_1+0xf9e>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9e:	fa650513          	addi	a0,a0,-90 # 6b40 <longjmp_1+0xf9e>
    ...
    2bf2:	31250513          	addi	a0,a0,786 # 5f00 <longjmp_1+0x35e>
    2bf6:	faa43c23          	sd	a0,-72(s0)
    2bfa:	00003797          	auipc	a5,0x3
    2bfe:	37678793          	addi	a5,a5,886 # 5f70 <longjmp_1+0x3ce>
...
0000000000002c20 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c30:	40450513          	addi	a0,a0,1028 # 7030 <longjmp_1+0x148e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c42:	24a50513          	addi	a0,a0,586 # 6e88 <longjmp_1+0x12e6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c58:	28c50513          	addi	a0,a0,652 # 6ee0 <longjmp_1+0x133e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c76:	2e650513          	addi	a0,a0,742 # 6f58 <longjmp_1+0x13b6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c92:	33a50513          	addi	a0,a0,826 # 6fc8 <longjmp_1+0x1426>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca4:	38050513          	addi	a0,a0,896 # 7020 <longjmp_1+0x147e>
  ...
  unlink("12345678901234");
    ...
    2d22:	14250513          	addi	a0,a0,322 # 6e60 <longjmp_1+0x12be>
    ...
    2d3e:	16e50513          	addi	a0,a0,366 # 6ea8 <longjmp_1+0x1306>
    ...
    2d5a:	1ba50513          	addi	a0,a0,442 # 6f10 <longjmp_1+0x136e>
    ...
    2d76:	21650513          	addi	a0,a0,534 # 6f88 <longjmp_1+0x13e6>
    ...
    2d92:	25a50513          	addi	a0,a0,602 # 6fe8 <longjmp_1+0x1446>
    ...
    2dae:	29650513          	addi	a0,a0,662 # 7040 <longjmp_1+0x149e>
...
0000000000002dc4 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd4:	2a850513          	addi	a0,a0,680 # 7078 <longjmp_1+0x14d6>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de8:	29450513          	addi	a0,a0,660 # 7078 <longjmp_1+0x14d6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfc:	2c050513          	addi	a0,a0,704 # 70b8 <longjmp_1+0x1516>
  ...
  if(chdir("/") < 0){
    ...
    2e10:	2dc50513          	addi	a0,a0,732 # 70e8 <longjmp_1+0x1546>
    ...
    2e30:	25450513          	addi	a0,a0,596 # 7080 <longjmp_1+0x14de>
    ...
    2e4c:	25050513          	addi	a0,a0,592 # 7098 <longjmp_1+0x14f6>
    ...
    2e68:	26450513          	addi	a0,a0,612 # 70c8 <longjmp_1+0x1526>
    ...
    2e84:	27050513          	addi	a0,a0,624 # 70f0 <longjmp_1+0x154e>
...
0000000000002e9a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb8:	1c450513          	addi	a0,a0,452 # 7078 <longjmp_1+0x14d6>
    ...
    2ecc:	1b050513          	addi	a0,a0,432 # 7078 <longjmp_1+0x14d6>
    ...
    2ee0:	1dc50513          	addi	a0,a0,476 # 70b8 <longjmp_1+0x1516>
    ...
    2f00:	83c50513          	addi	a0,a0,-1988 # 6738 <longjmp_1+0xb96>
    ...
    2f1c:	16850513          	addi	a0,a0,360 # 7080 <longjmp_1+0x14de>
    ...
    2f38:	1d450513          	addi	a0,a0,468 # 7108 <longjmp_1+0x1566>
    ...
    2f54:	17850513          	addi	a0,a0,376 # 70c8 <longjmp_1+0x1526>
...
0000000000002f82 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f92:	19250513          	addi	a0,a0,402 # 7120 <longjmp_1+0x157e>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa6:	17e50513          	addi	a0,a0,382 # 7120 <longjmp_1+0x157e>
  ...
  if(chdir("..") < 0){
    ...
    2fba:	18a50513          	addi	a0,a0,394 # 7140 <longjmp_1+0x159e>
  ...
  if(unlink("dir0") < 0){
    ...
    2fce:	15650513          	addi	a0,a0,342 # 7120 <longjmp_1+0x157e>
    ...
    2fee:	09650513          	addi	a0,a0,150 # 7080 <longjmp_1+0x14de>
    ...
    300a:	12250513          	addi	a0,a0,290 # 7128 <longjmp_1+0x1586>
    ...
    3026:	12650513          	addi	a0,a0,294 # 7148 <longjmp_1+0x15a6>
    ...
    3042:	12250513          	addi	a0,a0,290 # 7160 <longjmp_1+0x15be>
...
0000000000003058 <subdir>:
{
  ...
  unlink("ff");
    ...
    306a:	24250513          	addi	a0,a0,578 # 72a8 <longjmp_1+0x1706>
    306e:	00002097          	auipc	ra,0x2
    3072:	5f8080e7          	jalr	1528(ra) # 5666 <unlink>
  if(mkdir("dd") != 0){
    3076:	00004517          	auipc	a0,0x4
    307a:	10250513          	addi	a0,a0,258 # 7178 <longjmp_1+0x15d6>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3092:	10a50513          	addi	a0,a0,266 # 7198 <longjmp_1+0x15f6>
  ...
  write(fd, "ff", 2);
    ...
    30aa:	20258593          	addi	a1,a1,514 # 72a8 <longjmp_1+0x1706>
  ...
  if(unlink("dd") >= 0){
    ...
    30c4:	0b850513          	addi	a0,a0,184 # 7178 <longjmp_1+0x15d6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d8:	11c50513          	addi	a0,a0,284 # 71f0 <longjmp_1+0x164e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30f0:	12c50513          	addi	a0,a0,300 # 7218 <longjmp_1+0x1676>
  ...
  write(fd, "FF", 2);
    ...
    3108:	14458593          	addi	a1,a1,324 # 7248 <longjmp_1+0x16a6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3124:	13050513          	addi	a0,a0,304 # 7250 <longjmp_1+0x16ae>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    313c:	9e058593          	addi	a1,a1,-1568 # bb18 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3152:	9ca74703          	lbu	a4,-1590(a4) # bb18 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316c:	13858593          	addi	a1,a1,312 # 72a0 <longjmp_1+0x16fe>
    3170:	00004517          	auipc	a0,0x4
    3174:	0a850513          	addi	a0,a0,168 # 7218 <longjmp_1+0x1676>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3188:	09450513          	addi	a0,a0,148 # 7218 <longjmp_1+0x1676>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319e:	07e50513          	addi	a0,a0,126 # 7218 <longjmp_1+0x1676>
  ...
  if(chdir("dd") != 0){
    ...
    31b2:	fca50513          	addi	a0,a0,-54 # 7178 <longjmp_1+0x15d6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c6:	17650513          	addi	a0,a0,374 # 7338 <longjmp_1+0x1796>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31da:	19250513          	addi	a0,a0,402 # 7368 <longjmp_1+0x17c6>
  ...
  if(chdir("./..") != 0){
    ...
    31ee:	1ae50513          	addi	a0,a0,430 # 7398 <longjmp_1+0x17f6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3204:	0a050513          	addi	a0,a0,160 # 72a0 <longjmp_1+0x16fe>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    321c:	90058593          	addi	a1,a1,-1792 # bb18 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323e:	fde50513          	addi	a0,a0,-34 # 7218 <longjmp_1+0x1676>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3256:	1d650513          	addi	a0,a0,470 # 7428 <longjmp_1+0x1886>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326e:	1ee50513          	addi	a0,a0,494 # 7458 <longjmp_1+0x18b6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3286:	ef650513          	addi	a0,a0,-266 # 7178 <longjmp_1+0x15d6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329c:	ee050513          	addi	a0,a0,-288 # 7178 <longjmp_1+0x15d6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b2:	eca50513          	addi	a0,a0,-310 # 7178 <longjmp_1+0x15d6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c6:	22658593          	addi	a1,a1,550 # 74e8 <longjmp_1+0x1946>
    32ca:	00004517          	auipc	a0,0x4
    32ce:	15e50513          	addi	a0,a0,350 # 7428 <longjmp_1+0x1886>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e2:	20a58593          	addi	a1,a1,522 # 74e8 <longjmp_1+0x1946>
    32e6:	00004517          	auipc	a0,0x4
    32ea:	17250513          	addi	a0,a0,370 # 7458 <longjmp_1+0x18b6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fe:	fa658593          	addi	a1,a1,-90 # 72a0 <longjmp_1+0x16fe>
    3302:	00004517          	auipc	a0,0x4
    3306:	e9650513          	addi	a0,a0,-362 # 7198 <longjmp_1+0x15f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    331a:	11250513          	addi	a0,a0,274 # 7428 <longjmp_1+0x1886>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332e:	12e50513          	addi	a0,a0,302 # 7458 <longjmp_1+0x18b6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3342:	f6250513          	addi	a0,a0,-158 # 72a0 <longjmp_1+0x16fe>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3356:	10650513          	addi	a0,a0,262 # 7458 <longjmp_1+0x18b6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    336a:	0c250513          	addi	a0,a0,194 # 7428 <longjmp_1+0x1886>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337e:	e1e50513          	addi	a0,a0,-482 # 7198 <longjmp_1+0x15f6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3392:	2aa50513          	addi	a0,a0,682 # 7638 <longjmp_1+0x1a96>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a6:	efe50513          	addi	a0,a0,-258 # 72a0 <longjmp_1+0x16fe>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33ba:	de250513          	addi	a0,a0,-542 # 7198 <longjmp_1+0x15f6>
  ...
  if(unlink("dd") == 0){
    ...
    33ce:	dae50513          	addi	a0,a0,-594 # 7178 <longjmp_1+0x15d6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e2:	2ca50513          	addi	a0,a0,714 # 76a8 <longjmp_1+0x1b06>
  ...
  if(unlink("dd") < 0){
    ...
    33f6:	d8650513          	addi	a0,a0,-634 # 7178 <longjmp_1+0x15d6>
    ...
    3418:	d6c50513          	addi	a0,a0,-660 # 7180 <longjmp_1+0x15de>
    ...
    3434:	d7050513          	addi	a0,a0,-656 # 71a0 <longjmp_1+0x15fe>
    ...
    3450:	d7450513          	addi	a0,a0,-652 # 71c0 <longjmp_1+0x161e>
    ...
    346c:	d9050513          	addi	a0,a0,-624 # 71f8 <longjmp_1+0x1656>
    ...
    3488:	da450513          	addi	a0,a0,-604 # 7228 <longjmp_1+0x1686>
    ...
    34a4:	dc050513          	addi	a0,a0,-576 # 7260 <longjmp_1+0x16be>
    ...
    34c0:	dc450513          	addi	a0,a0,-572 # 7280 <longjmp_1+0x16de>
    ...
    34dc:	dd850513          	addi	a0,a0,-552 # 72b0 <longjmp_1+0x170e>
    ...
    34f8:	de450513          	addi	a0,a0,-540 # 72d8 <longjmp_1+0x1736>
    ...
    3514:	de850513          	addi	a0,a0,-536 # 72f8 <longjmp_1+0x1756>
    ...
    3530:	df450513          	addi	a0,a0,-524 # 7320 <longjmp_1+0x177e>
    ...
    354c:	e0050513          	addi	a0,a0,-512 # 7348 <longjmp_1+0x17a6>
    ...
    3568:	e1450513          	addi	a0,a0,-492 # 7378 <longjmp_1+0x17d6>
    ...
    3584:	e2050513          	addi	a0,a0,-480 # 73a0 <longjmp_1+0x17fe>
    ...
    35a0:	e1c50513          	addi	a0,a0,-484 # 73b8 <longjmp_1+0x1816>
    ...
    35bc:	e2050513          	addi	a0,a0,-480 # 73d8 <longjmp_1+0x1836>
    ...
    35d8:	e2450513          	addi	a0,a0,-476 # 73f8 <longjmp_1+0x1856>
    ...
    35f4:	e4850513          	addi	a0,a0,-440 # 7438 <longjmp_1+0x1896>
    ...
    3610:	e5c50513          	addi	a0,a0,-420 # 7468 <longjmp_1+0x18c6>
    ...
    362c:	e6050513          	addi	a0,a0,-416 # 7488 <longjmp_1+0x18e6>
    ...
    3648:	e6450513          	addi	a0,a0,-412 # 74a8 <longjmp_1+0x1906>
    ...
    3664:	e6850513          	addi	a0,a0,-408 # 74c8 <longjmp_1+0x1926>
    ...
    3680:	e7c50513          	addi	a0,a0,-388 # 74f8 <longjmp_1+0x1956>
    ...
    369c:	e8850513          	addi	a0,a0,-376 # 7520 <longjmp_1+0x197e>
    ...
    36b8:	e9450513          	addi	a0,a0,-364 # 7548 <longjmp_1+0x19a6>
    ...
    36d4:	ea050513          	addi	a0,a0,-352 # 7570 <longjmp_1+0x19ce>
    ...
    36f0:	ea450513          	addi	a0,a0,-348 # 7590 <longjmp_1+0x19ee>
    ...
    370c:	ea850513          	addi	a0,a0,-344 # 75b0 <longjmp_1+0x1a0e>
    ...
    3728:	eb450513          	addi	a0,a0,-332 # 75d8 <longjmp_1+0x1a36>
    ...
    3744:	eb850513          	addi	a0,a0,-328 # 75f8 <longjmp_1+0x1a56>
    ...
    3760:	ebc50513          	addi	a0,a0,-324 # 7618 <longjmp_1+0x1a76>
    ...
    377c:	ec850513          	addi	a0,a0,-312 # 7640 <longjmp_1+0x1a9e>
    ...
    3798:	b4450513          	addi	a0,a0,-1212 # 72d8 <longjmp_1+0x1736>
    ...
    37b4:	eb050513          	addi	a0,a0,-336 # 7660 <longjmp_1+0x1abe>
    ...
    37d0:	eb450513          	addi	a0,a0,-332 # 7680 <longjmp_1+0x1ade>
    ...
    37ec:	ec850513          	addi	a0,a0,-312 # 76b0 <longjmp_1+0x1b0e>
    ...
    3808:	ecc50513          	addi	a0,a0,-308 # 76d0 <longjmp_1+0x1b2e>
...
000000000000381e <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382e:	ebe50513          	addi	a0,a0,-322 # 76e8 <longjmp_1+0x1b46>
  ...
  if(chdir("dots") != 0){
    ...
    3840:	eac50513          	addi	a0,a0,-340 # 76e8 <longjmp_1+0x1b46>
  ...
  if(unlink(".") == 0){
    ...
    3852:	d4a50513          	addi	a0,a0,-694 # 6598 <longjmp_1+0x9f6>
  ...
  if(unlink("..") == 0){
    ...
    3864:	8e050513          	addi	a0,a0,-1824 # 7140 <longjmp_1+0x159e>
  ...
  if(chdir("/") != 0){
    ...
    3876:	87650513          	addi	a0,a0,-1930 # 70e8 <longjmp_1+0x1546>
  ...
  if(unlink("dots/.") == 0){
    ...
    3888:	ecc50513          	addi	a0,a0,-308 # 7750 <longjmp_1+0x1bae>
  ...
  if(unlink("dots/..") == 0){
    ...
    389a:	ee250513          	addi	a0,a0,-286 # 7778 <longjmp_1+0x1bd6>
  ...
  if(unlink("dots") != 0){
    ...
    38ac:	e4050513          	addi	a0,a0,-448 # 76e8 <longjmp_1+0x1b46>
    ...
    38ca:	e2a50513          	addi	a0,a0,-470 # 76f0 <longjmp_1+0x1b4e>
    ...
    38e6:	e2650513          	addi	a0,a0,-474 # 7708 <longjmp_1+0x1b66>
    ...
    3902:	e2250513          	addi	a0,a0,-478 # 7720 <longjmp_1+0x1b7e>
    ...
    391e:	e1e50513          	addi	a0,a0,-482 # 7738 <longjmp_1+0x1b96>
    ...
    393a:	7ba50513          	addi	a0,a0,1978 # 70f0 <longjmp_1+0x154e>
    ...
    3956:	e0650513          	addi	a0,a0,-506 # 7758 <longjmp_1+0x1bb6>
    ...
    3972:	e1250513          	addi	a0,a0,-494 # 7780 <longjmp_1+0x1bde>
    ...
    398e:	e1650513          	addi	a0,a0,-490 # 77a0 <longjmp_1+0x1bfe>
...
00000000000039a4 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39ba:	4ea50513          	addi	a0,a0,1258 # 5ea0 <longjmp_1+0x2fe>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d6:	4ce50513          	addi	a0,a0,1230 # 5ea0 <longjmp_1+0x2fe>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39ea:	e1a50513          	addi	a0,a0,-486 # 7800 <longjmp_1+0x1c5e>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a02:	e0250513          	addi	a0,a0,-510 # 7800 <longjmp_1+0x1c5e>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a16:	dee50513          	addi	a0,a0,-530 # 7800 <longjmp_1+0x1c5e>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a2a:	dda50513          	addi	a0,a0,-550 # 7800 <longjmp_1+0x1c5e>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3e:	dc658593          	addi	a1,a1,-570 # 7800 <longjmp_1+0x1c5e>
    3a42:	00002517          	auipc	a0,0x2
    3a46:	65650513          	addi	a0,a0,1622 # 6098 <longjmp_1+0x4f6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a5a:	44a50513          	addi	a0,a0,1098 # 5ea0 <longjmp_1+0x2fe>
  ...
  fd = open(".", O_RDWR);
    ...
    3a70:	b2c50513          	addi	a0,a0,-1236 # 6598 <longjmp_1+0x9f6>
  ...
  fd = open(".", 0);
    ...
    3a86:	b1650513          	addi	a0,a0,-1258 # 6598 <longjmp_1+0x9f6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a9a:	4da58593          	addi	a1,a1,1242 # 5f70 <longjmp_1+0x3ce>
  ...
  close(fd);
    ...
    3ac6:	cfe50513          	addi	a0,a0,-770 # 77c0 <longjmp_1+0x1c1e>
    ...
    3ae2:	d0250513          	addi	a0,a0,-766 # 77e0 <longjmp_1+0x1c3e>
    ...
    3afe:	d1650513          	addi	a0,a0,-746 # 7810 <longjmp_1+0x1c6e>
    ...
    3b1a:	cfa50513          	addi	a0,a0,-774 # 7810 <longjmp_1+0x1c6e>
    ...
    3b36:	d0650513          	addi	a0,a0,-762 # 7838 <longjmp_1+0x1c96>
    ...
    3b52:	d1250513          	addi	a0,a0,-750 # 7860 <longjmp_1+0x1cbe>
    ...
    3b6e:	d1e50513          	addi	a0,a0,-738 # 7888 <longjmp_1+0x1ce6>
    ...
    3b8a:	d2a50513          	addi	a0,a0,-726 # 78b0 <longjmp_1+0x1d0e>
    ...
    3ba6:	d2e50513          	addi	a0,a0,-722 # 78d0 <longjmp_1+0x1d2e>
    ...
    3bc2:	d3a50513          	addi	a0,a0,-710 # 78f8 <longjmp_1+0x1d56>
...
0000000000003bd8 <iref>:
{
    ...
    3bf6:	d1ea0a13          	addi	s4,s4,-738 # 7910 <longjmp_1+0x1d6e>
    mkdir("");
    3bfa:	00004497          	auipc	s1,0x4
    3bfe:	82648493          	addi	s1,s1,-2010 # 7420 <longjmp_1+0x187e>
    link("README", "");
    3c02:	00002a97          	auipc	s5,0x2
    3c06:	496a8a93          	addi	s5,s5,1174 # 6098 <longjmp_1+0x4f6>
    fd = open("xx", O_CREATE);
    3c0a:	00004997          	auipc	s3,0x4
    3c0e:	bfe98993          	addi	s3,s3,-1026 # 7808 <longjmp_1+0x1c66>
    3c12:	a891                	j	3c66 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c14:	85da                	mv	a1,s6
    3c16:	00004517          	auipc	a0,0x4
    3c1a:	d0250513          	addi	a0,a0,-766 # 7918 <longjmp_1+0x1d76>
    ...
    3c36:	cfe50513          	addi	a0,a0,-770 # 7930 <longjmp_1+0x1d8e>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cca:	47a98993          	addi	s3,s3,1146 # 7140 <longjmp_1+0x159e>
    unlink("irefd");
    3cce:	00004917          	auipc	s2,0x4
    3cd2:	c4290913          	addi	s2,s2,-958 # 7910 <longjmp_1+0x1d6e>
    chdir("..");
    3cd6:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf2:	3fa50513          	addi	a0,a0,1018 # 70e8 <longjmp_1+0x1546>
...
0000000000003d12 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d22:	c2a50513          	addi	a0,a0,-982 # 7948 <longjmp_1+0x1da6>
  ...
  if(pid == 0){
    ...
    3d46:	c0650513          	addi	a0,a0,-1018 # 7948 <longjmp_1+0x1da6>
    ...
    3d5c:	c1050513          	addi	a0,a0,-1008 # 7968 <longjmp_1+0x1dc6>
    ...
    3d78:	bdc50513          	addi	a0,a0,-1060 # 7950 <longjmp_1+0x1dae>
    ...
    3d94:	9a850513          	addi	a0,a0,-1624 # 6738 <longjmp_1+0xb96>
  ...
  if(unlink("oidir") != 0){
    ...
    3dc2:	b8a50513          	addi	a0,a0,-1142 # 7948 <longjmp_1+0x1da6>
    ...
    3dd6:	b5650513          	addi	a0,a0,-1194 # 6928 <longjmp_1+0xd86>
...
0000000000003e04 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e14:	b8050513          	addi	a0,a0,-1152 # 7990 <longjmp_1+0x1dee>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e40:	b5450513          	addi	a0,a0,-1196 # 7990 <longjmp_1+0x1dee>
  ...
  sleep(10); // one second
    ...
    3e78:	a8450513          	addi	a0,a0,-1404 # 68f8 <longjmp_1+0xd56>
    ...
    3e92:	b0248493          	addi	s1,s1,-1278 # 7990 <longjmp_1+0x1dee>
    3e96:	4581                	li	a1,0
    3e98:	8526                	mv	a0,s1
...
0000000000003ed4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3efe:	9fe50513          	addi	a0,a0,-1538 # 68f8 <longjmp_1+0xd56>
  ...
  if(pid2 == 0)
    ...
    3f2c:	81050513          	addi	a0,a0,-2032 # 6738 <longjmp_1+0xb96>
  ...
  if(pid3 == 0){
    ...
    3f70:	00458593          	addi	a1,a1,4 # 5f70 <longjmp_1+0x3ce>
    ...
    3f9a:	7a250513          	addi	a0,a0,1954 # 6738 <longjmp_1+0xb96>
    ...
    3fb6:	9ee50513          	addi	a0,a0,-1554 # 79a0 <longjmp_1+0x1dfe>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3fd6:	b4658593          	addi	a1,a1,-1210 # bb18 <buf>
    ...
    3ff2:	9ca50513          	addi	a0,a0,-1590 # 79b8 <longjmp_1+0x1e16>
  ...
  printf("kill... ");
    ...
    401e:	9b650513          	addi	a0,a0,-1610 # 79d0 <longjmp_1+0x1e2e>
  ...
  printf("wait... ");
    ...
    404c:	99850513          	addi	a0,a0,-1640 # 79e0 <longjmp_1+0x1e3e>
...
0000000000004078 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    40ae:	79650513          	addi	a0,a0,1942 # 6840 <longjmp_1+0xc9e>
    ...
    40e4:	e9058593          	addi	a1,a1,-368 # 5f70 <longjmp_1+0x3ce>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    41a8:	84c50513          	addi	a0,a0,-1972 # 79f0 <longjmp_1+0x1e4e>
    ...
    41c4:	57850513          	addi	a0,a0,1400 # 6738 <longjmp_1+0xb96>
    ...
    4210:	80450513          	addi	a0,a0,-2044 # 7a10 <longjmp_1+0x1e6e>
...
0000000000004230 <reparent>:
{
  ...
  exit(0);
    ...
    4284:	4b850513          	addi	a0,a0,1208 # 6738 <longjmp_1+0xb96>
    ...
    42a0:	62450513          	addi	a0,a0,1572 # 68c0 <longjmp_1+0xd1e>
...
00000000000042e0 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4348:	6fc50513          	addi	a0,a0,1788 # 7a40 <longjmp_1+0x1e9e>
...
0000000000004386 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    441c:	64850513          	addi	a0,a0,1608 # 7a60 <longjmp_1+0x1ebe>
    ...
    4438:	65450513          	addi	a0,a0,1620 # 7a88 <longjmp_1+0x1ee6>
  ...
  fd = open("sharedfd", 0);
    ...
    447c:	8c850513          	addi	a0,a0,-1848 # 5d40 <longjmp_1+0x19e>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    44bc:	5f050513          	addi	a0,a0,1520 # 7aa8 <longjmp_1+0x1f06>
    ...
    44d6:	fd2783e3          	beq	a5,s2,449c <sharedfd+0x116>
      if(buf[i] == 'c')
    44da:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f14d8>
  ...
  unlink("sharedfd");
    ...
    44f8:	84c50513          	addi	a0,a0,-1972 # 5d40 <longjmp_1+0x19e>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    451e:	5b650513          	addi	a0,a0,1462 # 7ad0 <longjmp_1+0x1f2e>
...
000000000000453e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4562:	64a78793          	addi	a5,a5,1610 # 5ba8 <longjmp_1+0x6>
    4566:	f6f43823          	sd	a5,-144(s0)
    456a:	00001797          	auipc	a5,0x1
    456e:	64678793          	addi	a5,a5,1606 # 5bb0 <longjmp_1+0xe>
    4572:	f6f43c23          	sd	a5,-136(s0)
    4576:	00001797          	auipc	a5,0x1
    457a:	64278793          	addi	a5,a5,1602 # 5bb8 <longjmp_1+0x16>
    457e:	f8f43023          	sd	a5,-128(s0)
    4582:	00001797          	auipc	a5,0x1
    4586:	63e78793          	addi	a5,a5,1598 # 5bc0 <longjmp_1+0x1e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    45e0:	53ca0a13          	addi	s4,s4,1340 # bb18 <buf>
    45e4:	00007a97          	auipc	s5,0x7
    45e8:	535a8a93          	addi	s5,s5,1333 # bb19 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    45fe:	54650513          	addi	a0,a0,1350 # 6b40 <longjmp_1+0xf9e>
    ...
    4678:	47450513          	addi	a0,a0,1140 # 7ae8 <longjmp_1+0x1f46>
    ...
    4692:	46a50513          	addi	a0,a0,1130 # 7af8 <longjmp_1+0x1f56>
    ...
    46b6:	45e50513          	addi	a0,a0,1118 # 7b10 <longjmp_1+0x1f6e>
    ...
    46e6:	43678793          	addi	a5,a5,1078 # bb18 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4746:	3de50513          	addi	a0,a0,990 # 7b20 <longjmp_1+0x1f7e>
...
000000000000477a <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47a8:	394b8b93          	addi	s7,s7,916 # 7b38 <longjmp_1+0x1f96>
  for(i = 0; i < N; i++){
    ...
    47ea:	35a50513          	addi	a0,a0,858 # 7b40 <longjmp_1+0x1f9e>
    ...
    4808:	33450513          	addi	a0,a0,820 # 7b38 <longjmp_1+0x1f96>
  ...
  fd = open(".", 0);
    ...
    4840:	d5c50513          	addi	a0,a0,-676 # 6598 <longjmp_1+0x9f6>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4866:	2fe50513          	addi	a0,a0,766 # 7b60 <longjmp_1+0x1fbe>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    48d6:	2ae50513          	addi	a0,a0,686 # 7b80 <longjmp_1+0x1fde>
  ...
  for(i = 0; i < N; i++){
    ...
    490e:	29e50513          	addi	a0,a0,670 # 7ba8 <longjmp_1+0x2006>
    ...
    492a:	e1250513          	addi	a0,a0,-494 # 6738 <longjmp_1+0xb96>
...
0000000000004ad4 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b14:	00890913          	addi	s2,s2,8 # bb18 <buf>
  for(i = 0; i < N; i++){
    4b18:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4b5c:	08850513          	addi	a0,a0,136 # 7be0 <longjmp_1+0x203e>
  ...
  for(i = 0; ; i++){
    ...
    4b72:	faa90913          	addi	s2,s2,-86 # bb18 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4bc0:	03450513          	addi	a0,a0,52 # 7bf0 <longjmp_1+0x204e>
    ...
    4bdc:	03850513          	addi	a0,a0,56 # 7c10 <longjmp_1+0x206e>
    ...
    4bf8:	03c50513          	addi	a0,a0,60 # 7c30 <longjmp_1+0x208e>
    ...
    4c14:	04050513          	addi	a0,a0,64 # 7c50 <longjmp_1+0x20ae>
    ...
    4c30:	04450513          	addi	a0,a0,68 # 7c70 <longjmp_1+0x20ce>
    ...
    4c4c:	04050513          	addi	a0,a0,64 # 7c88 <longjmp_1+0x20e6>
  ...
  unlink("bigfile.dat");
    ...
    4c7a:	f6a50513          	addi	a0,a0,-150 # 7be0 <longjmp_1+0x203e>
    ...
    4c9e:	00e50513          	addi	a0,a0,14 # 7ca8 <longjmp_1+0x2106>
...
0000000000004cb4 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4cd6:	ff650513          	addi	a0,a0,-10 # 7cc8 <longjmp_1+0x2126>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4cf6:	fe6c8c93          	addi	s9,s9,-26 # 7cd8 <longjmp_1+0x2136>
    int total = 0;
    4cfa:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4cfc:	00007a17          	auipc	s4,0x7
    4d00:	e1ca0a13          	addi	s4,s4,-484 # bb18 <buf>
    name[0] = 'f';
    ...
    4d70:	f7c50513          	addi	a0,a0,-132 # 7ce8 <longjmp_1+0x2146>
  ...
  printf("fsfull test finished\n");
    ...
    4de6:	f2650513          	addi	a0,a0,-218 # 7d08 <longjmp_1+0x2166>
    ...
    4e36:	ec650513          	addi	a0,a0,-314 # 7cf8 <longjmp_1+0x2156>
...
0000000000004e54 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4e5e:	49670713          	addi	a4,a4,1174 # 82f0 <randstate>
    4e62:	6308                	ld	a0,0(a4)
    4e64:	001967b7          	lui	a5,0x196
    4e68:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187ae5>
    4e6c:	02f50533          	mul	a0,a0,a5
    4e70:	3c6ef7b7          	lui	a5,0x3c6ef
    4e74:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e0837>
...
0000000000004e84 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4ef8:	e2c50513          	addi	a0,a0,-468 # 7d20 <longjmp_1+0x217e>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4f10:	06458593          	addi	a1,a1,100 # 5f70 <longjmp_1+0x3ce>
    ...
    4f26:	e1e50513          	addi	a0,a0,-482 # 7d40 <longjmp_1+0x219e>
    ...
    4f40:	dec50513          	addi	a0,a0,-532 # 7d28 <longjmp_1+0x2186>
    ...
    4f5a:	dd250513          	addi	a0,a0,-558 # 7d28 <longjmp_1+0x2186>
  ...
  unlink("junk");
    ...
    4f7e:	da650513          	addi	a0,a0,-602 # 7d20 <longjmp_1+0x217e>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4fd4:	fa090913          	addi	s2,s2,-96 # 5f70 <longjmp_1+0x3ce>
      uint64 a = (uint64) sbrk(4096);
    ...
    5008:	d8c50513          	addi	a0,a0,-628 # 7d90 <longjmp_1+0x21ee>
    ...
    5022:	d3250513          	addi	a0,a0,-718 # 7d50 <longjmp_1+0x21ae>
    ...
    503c:	d3850513          	addi	a0,a0,-712 # 7d70 <longjmp_1+0x21ce>
  ...
  while(1){
    ...
    508a:	d2a50513          	addi	a0,a0,-726 # 7db0 <longjmp_1+0x220e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    50da:	cfa50513          	addi	a0,a0,-774 # 7dd0 <longjmp_1+0x222e>
  ...
  if(pid == 0) {
    ...
    510a:	cf250513          	addi	a0,a0,-782 # 7df8 <longjmp_1+0x2256>
    ...
    512e:	cb650513          	addi	a0,a0,-842 # 7de0 <longjmp_1+0x223e>
    ...
    5156:	cae50513          	addi	a0,a0,-850 # 7e00 <longjmp_1+0x225e>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    519e:	d7e78793          	addi	a5,a5,-642 # 7f18 <longjmp_1+0x2376>
    51a2:	c1040713          	addi	a4,s0,-1008
    51a6:	00003817          	auipc	a6,0x3
    51aa:	11280813          	addi	a6,a6,274 # 82b8 <longjmp_1+0x2716>
  ...
  printf("usertests starting\n");
    ...
    51d6:	ce650513          	addi	a0,a0,-794 # 7eb8 <longjmp_1+0x2316>
  ...
  if(fail){
    ...
    520e:	c6650513          	addi	a0,a0,-922 # 7e70 <longjmp_1+0x22ce>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    522a:	be258593          	addi	a1,a1,-1054 # 7e08 <longjmp_1+0x2266>
    ...
    5240:	cb458593          	addi	a1,a1,-844 # 7ef0 <longjmp_1+0x234e>
    ...
    5264:	bb050513          	addi	a0,a0,-1104 # 7e10 <longjmp_1+0x226e>
  ...
  if(fail){
    ...
    52d0:	b8c50513          	addi	a0,a0,-1140 # 7e58 <longjmp_1+0x22b6>
    ...
    52ea:	bba50513          	addi	a0,a0,-1094 # 7ea0 <longjmp_1+0x22fe>
    ...
    5348:	bd478793          	addi	a5,a5,-1068 # 7f18 <longjmp_1+0x2376>
    534c:	c1040713          	addi	a4,s0,-1008
    5350:	00003817          	auipc	a6,0x3
    5354:	f6880813          	addi	a6,a6,-152 # 82b8 <longjmp_1+0x2716>
    ...
    5380:	b5450513          	addi	a0,a0,-1196 # 7ed0 <longjmp_1+0x232e>
    5384:	00000097          	auipc	ra,0x0
    5388:	60a080e7          	jalr	1546(ra) # 598e <printf>
        printf("SOME TESTS FAILED\n");
    538c:	00003a97          	auipc	s5,0x3
    5390:	acca8a93          	addi	s5,s5,-1332 # 7e58 <longjmp_1+0x22b6>
        if(continuous != 2)
    5394:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5396:	00003b17          	auipc	s6,0x3
    539a:	aa2b0b13          	addi	s6,s6,-1374 # 7e38 <longjmp_1+0x2296>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    56fe:	bd650513          	addi	a0,a0,-1066 # 82d0 <digits>
    5702:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    57ca:	b0ab8b93          	addi	s7,s7,-1270 # 82d0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    590a:	9c290913          	addi	s2,s2,-1598 # 82c8 <longjmp_1+0x2726>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    59d2:	92a7b783          	ld	a5,-1750(a5) # 82f8 <freep>
    ...
    5a00:	00e6ea63          	bltu	a3,a4,5a14 <free+0x50>
{
  ...
  freep = p;
    ...
    5a42:	8af73d23          	sd	a5,-1862(a4) # 82f8 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5a74:	88853503          	ld	a0,-1912(a0) # 82f8 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5a9c:	86090913          	addi	s2,s2,-1952 # 82f8 <freep>
  if(p == (char*)-1)
    5aa0:	5afd                	li	s5,-1
    5aa2:	a88d                	j	5b14 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5aa4:	00009797          	auipc	a5,0x9
    5aa8:	07478793          	addi	a5,a5,116 # eb18 <base>
    5aac:	00003717          	auipc	a4,0x3
    5ab0:	84f73623          	sd	a5,-1972(a4) # 82f8 <freep>
    ...
    5ad6:	82a73323          	sd	a0,-2010(a4) # 82f8 <freep>
      return (void*)(p + 1);
...
0000000000005b30 <setjmp>:
    5b30:	e100                	sd	s0,0(a0)
    5b32:	e504                	sd	s1,8(a0)
    5b34:	01253823          	sd	s2,16(a0)
    5b38:	01353c23          	sd	s3,24(a0)
    5b3c:	03453023          	sd	s4,32(a0)
    5b40:	03553423          	sd	s5,40(a0)
    5b44:	03653823          	sd	s6,48(a0)
    5b48:	03753c23          	sd	s7,56(a0)
    5b4c:	05853023          	sd	s8,64(a0)
    5b50:	05953423          	sd	s9,72(a0)
    5b54:	05a53823          	sd	s10,80(a0)
    5b58:	05b53c23          	sd	s11,88(a0)
    5b5c:	06153023          	sd	ra,96(a0)
    5b60:	06253423          	sd	sp,104(a0)
    5b64:	4501                	li	a0,0
    5b66:	8082                	ret

0000000000005b68 <longjmp>:
    5b68:	6100                	ld	s0,0(a0)
    5b6a:	6504                	ld	s1,8(a0)
    5b6c:	01053903          	ld	s2,16(a0)
    5b70:	01853983          	ld	s3,24(a0)
    5b74:	02053a03          	ld	s4,32(a0)
    5b78:	02853a83          	ld	s5,40(a0)
    5b7c:	03053b03          	ld	s6,48(a0)
    5b80:	03853b83          	ld	s7,56(a0)
    5b84:	04053c03          	ld	s8,64(a0)
    5b88:	04853c83          	ld	s9,72(a0)
    5b8c:	05053d03          	ld	s10,80(a0)
    5b90:	05853d83          	ld	s11,88(a0)
    5b94:	06053083          	ld	ra,96(a0)
    5b98:	06853103          	ld	sp,104(a0)
    5b9c:	c199                	beqz	a1,5ba2 <longjmp_1>
    5b9e:	852e                	mv	a0,a1
    5ba0:	8082                	ret

0000000000005ba2 <longjmp_1>:
    5ba2:	4505                	li	a0,1
    5ba4:	8082                	ret
