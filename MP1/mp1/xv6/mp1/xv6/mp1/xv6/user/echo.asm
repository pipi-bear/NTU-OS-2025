...
main(int argc, char *argv[])
{
  ...
  2e:	866a0a13          	addi	s4,s4,-1946 # 890 <longjmp_1+0xa>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	83058593          	addi	a1,a1,-2000 # 898 <longjmp_1+0x12>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	4ca50513          	addi	a0,a0,1226 # 8a8 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ae:	3feb8b93          	addi	s7,s7,1022 # 8a8 <digits>
 ...
 5ee:	2b690913          	addi	s2,s2,694 # 8a0 <longjmp_1+0x1a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b6:	20e7b783          	ld	a5,526(a5) # 8c0 <freep>
 ...
 6e4:	00e6ea63          	bltu	a3,a4,6f8 <free+0x50>
{
 ...
 726:	18f73f23          	sd	a5,414(a4) # 8c0 <freep>
}
 72a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 758:	16c53503          	ld	a0,364(a0) # 8c0 <freep>
 ...
 780:	14490913          	addi	s2,s2,324 # 8c0 <freep>
  if(p == (char*)-1)
 784:	5afd                	li	s5,-1
 786:	a88d                	j	7f8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 788:	00000797          	auipc	a5,0x0
 78c:	14078793          	addi	a5,a5,320 # 8c8 <base>
 790:	00000717          	auipc	a4,0x0
 794:	12f73823          	sd	a5,304(a4) # 8c0 <freep>
 798:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
...
0000000000000814 <setjmp>:
 814:	e100                	sd	s0,0(a0)
 816:	e504                	sd	s1,8(a0)
 818:	01253823          	sd	s2,16(a0)
 81c:	01353c23          	sd	s3,24(a0)
 820:	03453023          	sd	s4,32(a0)
 824:	03553423          	sd	s5,40(a0)
 828:	03653823          	sd	s6,48(a0)
 82c:	03753c23          	sd	s7,56(a0)
 830:	05853023          	sd	s8,64(a0)
 834:	05953423          	sd	s9,72(a0)
 838:	05a53823          	sd	s10,80(a0)
 83c:	05b53c23          	sd	s11,88(a0)
 840:	06153023          	sd	ra,96(a0)
 844:	06253423          	sd	sp,104(a0)
 848:	4501                	li	a0,0
 84a:	8082                	ret

000000000000084c <longjmp>:
 84c:	6100                	ld	s0,0(a0)
 84e:	6504                	ld	s1,8(a0)
 850:	01053903          	ld	s2,16(a0)
 854:	01853983          	ld	s3,24(a0)
 858:	02053a03          	ld	s4,32(a0)
 85c:	02853a83          	ld	s5,40(a0)
 860:	03053b03          	ld	s6,48(a0)
 864:	03853b83          	ld	s7,56(a0)
 868:	04053c03          	ld	s8,64(a0)
 86c:	04853c83          	ld	s9,72(a0)
 870:	05053d03          	ld	s10,80(a0)
 874:	05853d83          	ld	s11,88(a0)
 878:	06053083          	ld	ra,96(a0)
 87c:	06853103          	ld	sp,104(a0)
 880:	c199                	beqz	a1,886 <longjmp_1>
 882:	852e                	mv	a0,a1
 884:	8082                	ret

0000000000000886 <longjmp_1>:
 886:	4505                	li	a0,1
 888:	8082                	ret
