...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	35058593          	addi	a1,a1,848 # 1360 <longjmp_1+0xa>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	30a58593          	addi	a1,a1,778 # 1368 <longjmp_1+0x12>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2d850513          	addi	a0,a0,728 # 1370 <longjmp_1+0x1a>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3ac70713          	addi	a4,a4,940 # 1470 <longjmp_1+0x11a>
    ...
    panic("runcmd");
      ...
      e2:	29a50513          	addi	a0,a0,666 # 1378 <longjmp_1+0x22>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	28058593          	addi	a1,a1,640 # 1380 <longjmp_1+0x2a>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	24458593          	addi	a1,a1,580 # 1390 <longjmp_1+0x3a>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	1be50513          	addi	a0,a0,446 # 13a0 <longjmp_1+0x4a>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	06a98993          	addi	s3,s3,106 # 14c8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	00098993          	mv	s3,s3
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	ff0a8a93          	addi	s5,s5,-16 # 14c0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f9698993          	addi	s3,s3,-106 # 14c8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e26b8b93          	addi	s7,s7,-474 # 13c8 <longjmp_1+0x72>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	df450513          	addi	a0,a0,-524 # 13a8 <longjmp_1+0x52>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d3460613          	addi	a2,a2,-716 # 13d0 <longjmp_1+0x7a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d24b0b13          	addi	s6,s6,-732 # 13f0 <longjmp_1+0x9a>
  ...
  return ret;
     ...
     70a:	cd250513          	addi	a0,a0,-814 # 13d8 <longjmp_1+0x82>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c7850513          	addi	a0,a0,-904 # 13e0 <longjmp_1+0x8a>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c5660613          	addi	a2,a2,-938 # 13f8 <longjmp_1+0xa2>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	beea0a13          	addi	s4,s4,-1042 # 1400 <longjmp_1+0xaa>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	bc060613          	addi	a2,a2,-1088 # 1408 <longjmp_1+0xb2>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b2260613          	addi	a2,a2,-1246 # 13d0 <longjmp_1+0x7a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b4260613          	addi	a2,a2,-1214 # 1420 <longjmp_1+0xca>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	af050513          	addi	a0,a0,-1296 # 1410 <longjmp_1+0xba>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	af850513          	addi	a0,a0,-1288 # 1428 <longjmp_1+0xd2>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b2c70713          	addi	a4,a4,-1236 # 1488 <longjmp_1+0x132>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a3860613          	addi	a2,a2,-1480 # 1440 <longjmp_1+0xea>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	a0a58593          	addi	a1,a1,-1526 # 1448 <longjmp_1+0xf2>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6cc080e7          	jalr	1740(ra) # 1114 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	98850513          	addi	a0,a0,-1656 # 13d8 <longjmp_1+0x82>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9e648493          	addi	s1,s1,-1562 # 1458 <longjmp_1+0x102>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a4048493          	addi	s1,s1,-1472 # 14d8 <buf.1133>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a33a0a13          	addi	s4,s4,-1485 # 14db <buf.1133+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	9b0a8a93          	addi	s5,s5,-1616 # 1460 <longjmp_1+0x10a>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	9a650513          	addi	a0,a0,-1626 # 14d8 <buf.1133>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eb2:	5fa50513          	addi	a0,a0,1530 # 14a8 <digits>
     eb6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f7e:	52eb8b93          	addi	s7,s7,1326 # 14a8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10be:	3e690913          	addi	s2,s2,998 # 14a0 <longjmp_1+0x14a>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1186:	34e7b783          	ld	a5,846(a5) # 14d0 <freep>
    ...
    11b4:	00e6ea63          	bltu	a3,a4,11c8 <free+0x50>
{
  ...
  freep = p;
    ...
    11f6:	2cf73f23          	sd	a5,734(a4) # 14d0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1228:	2ac53503          	ld	a0,684(a0) # 14d0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1250:	28490913          	addi	s2,s2,644 # 14d0 <freep>
  if(p == (char*)-1)
    1254:	5afd                	li	s5,-1
    1256:	a88d                	j	12c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1258:	00000797          	auipc	a5,0x0
    125c:	2e878793          	addi	a5,a5,744 # 1540 <base>
    1260:	00000717          	auipc	a4,0x0
    1264:	26f73823          	sd	a5,624(a4) # 14d0 <freep>
    ...
    128a:	24a73523          	sd	a0,586(a4) # 14d0 <freep>
      return (void*)(p + 1);
...
00000000000012e4 <setjmp>:
    12e4:	e100                	sd	s0,0(a0)
    12e6:	e504                	sd	s1,8(a0)
    12e8:	01253823          	sd	s2,16(a0)
    12ec:	01353c23          	sd	s3,24(a0)
    12f0:	03453023          	sd	s4,32(a0)
    12f4:	03553423          	sd	s5,40(a0)
    12f8:	03653823          	sd	s6,48(a0)
    12fc:	03753c23          	sd	s7,56(a0)
    1300:	05853023          	sd	s8,64(a0)
    1304:	05953423          	sd	s9,72(a0)
    1308:	05a53823          	sd	s10,80(a0)
    130c:	05b53c23          	sd	s11,88(a0)
    1310:	06153023          	sd	ra,96(a0)
    1314:	06253423          	sd	sp,104(a0)
    1318:	4501                	li	a0,0
    131a:	8082                	ret

000000000000131c <longjmp>:
    131c:	6100                	ld	s0,0(a0)
    131e:	6504                	ld	s1,8(a0)
    1320:	01053903          	ld	s2,16(a0)
    1324:	01853983          	ld	s3,24(a0)
    1328:	02053a03          	ld	s4,32(a0)
    132c:	02853a83          	ld	s5,40(a0)
    1330:	03053b03          	ld	s6,48(a0)
    1334:	03853b83          	ld	s7,56(a0)
    1338:	04053c03          	ld	s8,64(a0)
    133c:	04853c83          	ld	s9,72(a0)
    1340:	05053d03          	ld	s10,80(a0)
    1344:	05853d83          	ld	s11,88(a0)
    1348:	06053083          	ld	ra,96(a0)
    134c:	06853103          	ld	sp,104(a0)
    1350:	c199                	beqz	a1,1356 <longjmp_1>
    1352:	852e                	mv	a0,a1
    1354:	8082                	ret

0000000000001356 <longjmp_1>:
    1356:	4505                	li	a0,1
    1358:	8082                	ret
