...
main(void)
{
  ...
  12:	8f250513          	addi	a0,a0,-1806 # 900 <longjmp_1+0x6>
  ...
  3a:	8d290913          	addi	s2,s2,-1838 # 908 <longjmp_1+0xe>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8ee50513          	addi	a0,a0,-1810 # 958 <longjmp_1+0x5e>
  ...
  8c:	87850513          	addi	a0,a0,-1928 # 900 <longjmp_1+0x6>
  90:	00000097          	auipc	ra,0x0
  94:	326080e7          	jalr	806(ra) # 3b6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	86650513          	addi	a0,a0,-1946 # 900 <longjmp_1+0x6>
  a2:	00000097          	auipc	ra,0x0
  a6:	30c080e7          	jalr	780(ra) # 3ae <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	87450513          	addi	a0,a0,-1932 # 920 <longjmp_1+0x26>
  ...
  d2:	86a50513          	addi	a0,a0,-1942 # 938 <longjmp_1+0x3e>
  d6:	00000097          	auipc	ra,0x0
  da:	2d0080e7          	jalr	720(ra) # 3a6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	86250513          	addi	a0,a0,-1950 # 940 <longjmp_1+0x46>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	52e50513          	addi	a0,a0,1326 # 980 <digits>
 45a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 522:	462b8b93          	addi	s7,s7,1122 # 980 <digits>
 ...
 662:	31a90913          	addi	s2,s2,794 # 978 <longjmp_1+0x7e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 72a:	2827b783          	ld	a5,642(a5) # 9a8 <freep>
 ...
 758:	00e6ea63          	bltu	a3,a4,76c <free+0x50>
{
 ...
 79a:	20f73923          	sd	a5,530(a4) # 9a8 <freep>
}
 79e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f4:	1b890913          	addi	s2,s2,440 # 9a8 <freep>
  if(p == (char*)-1)
 7f8:	5afd                	li	s5,-1
 7fa:	a88d                	j	86c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7fc:	00000797          	auipc	a5,0x0
 800:	1b478793          	addi	a5,a5,436 # 9b0 <base>
 804:	00000717          	auipc	a4,0x0
 808:	1af73223          	sd	a5,420(a4) # 9a8 <freep>
 80c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 82e:	16a73f23          	sd	a0,382(a4) # 9a8 <freep>
      return (void*)(p + 1);
...
0000000000000888 <setjmp>:
 888:	e100                	sd	s0,0(a0)
 88a:	e504                	sd	s1,8(a0)
 88c:	01253823          	sd	s2,16(a0)
 890:	01353c23          	sd	s3,24(a0)
 894:	03453023          	sd	s4,32(a0)
 898:	03553423          	sd	s5,40(a0)
 89c:	03653823          	sd	s6,48(a0)
 8a0:	03753c23          	sd	s7,56(a0)
 8a4:	05853023          	sd	s8,64(a0)
 8a8:	05953423          	sd	s9,72(a0)
 8ac:	05a53823          	sd	s10,80(a0)
 8b0:	05b53c23          	sd	s11,88(a0)
 8b4:	06153023          	sd	ra,96(a0)
 8b8:	06253423          	sd	sp,104(a0)
 8bc:	4501                	li	a0,0
 8be:	8082                	ret

00000000000008c0 <longjmp>:
 8c0:	6100                	ld	s0,0(a0)
 8c2:	6504                	ld	s1,8(a0)
 8c4:	01053903          	ld	s2,16(a0)
 8c8:	01853983          	ld	s3,24(a0)
 8cc:	02053a03          	ld	s4,32(a0)
 8d0:	02853a83          	ld	s5,40(a0)
 8d4:	03053b03          	ld	s6,48(a0)
 8d8:	03853b83          	ld	s7,56(a0)
 8dc:	04053c03          	ld	s8,64(a0)
 8e0:	04853c83          	ld	s9,72(a0)
 8e4:	05053d03          	ld	s10,80(a0)
 8e8:	05853d83          	ld	s11,88(a0)
 8ec:	06053083          	ld	ra,96(a0)
 8f0:	06853103          	ld	sp,104(a0)
 8f4:	c199                	beqz	a1,8fa <longjmp_1>
 8f6:	852e                	mv	a0,a1
 8f8:	8082                	ret

00000000000008fa <longjmp_1>:
 8fa:	4505                	li	a0,1
 8fc:	8082                	ret
