...
main(int argc, char *argv[])
{
  ...
  42:	84258593          	addi	a1,a1,-1982 # 880 <longjmp_1+0x6>
  46:	4509                	li	a0,2
  ...
  60:	83c58593          	addi	a1,a1,-1988 # 898 <longjmp_1+0x1e>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	4ee50513          	addi	a0,a0,1262 # 8c0 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	422b8b93          	addi	s7,s7,1058 # 8c0 <digits>
 ...
 5e2:	2da90913          	addi	s2,s2,730 # 8b8 <longjmp_1+0x3e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6aa:	2327b783          	ld	a5,562(a5) # 8d8 <freep>
 ...
 6d8:	00e6ea63          	bltu	a3,a4,6ec <free+0x50>
{
 ...
 71a:	1cf73123          	sd	a5,450(a4) # 8d8 <freep>
}
 71e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74c:	19053503          	ld	a0,400(a0) # 8d8 <freep>
 ...
 774:	16890913          	addi	s2,s2,360 # 8d8 <freep>
  if(p == (char*)-1)
 778:	5afd                	li	s5,-1
 77a:	a88d                	j	7ec <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 77c:	00000797          	auipc	a5,0x0
 780:	16478793          	addi	a5,a5,356 # 8e0 <base>
 784:	00000717          	auipc	a4,0x0
 788:	14f73a23          	sd	a5,340(a4) # 8d8 <freep>
 78c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ae:	12a73723          	sd	a0,302(a4) # 8d8 <freep>
      return (void*)(p + 1);
...
0000000000000808 <setjmp>:
 808:	e100                	sd	s0,0(a0)
 80a:	e504                	sd	s1,8(a0)
 80c:	01253823          	sd	s2,16(a0)
 810:	01353c23          	sd	s3,24(a0)
 814:	03453023          	sd	s4,32(a0)
 818:	03553423          	sd	s5,40(a0)
 81c:	03653823          	sd	s6,48(a0)
 820:	03753c23          	sd	s7,56(a0)
 824:	05853023          	sd	s8,64(a0)
 828:	05953423          	sd	s9,72(a0)
 82c:	05a53823          	sd	s10,80(a0)
 830:	05b53c23          	sd	s11,88(a0)
 834:	06153023          	sd	ra,96(a0)
 838:	06253423          	sd	sp,104(a0)
 83c:	4501                	li	a0,0
 83e:	8082                	ret

0000000000000840 <longjmp>:
 840:	6100                	ld	s0,0(a0)
 842:	6504                	ld	s1,8(a0)
 844:	01053903          	ld	s2,16(a0)
 848:	01853983          	ld	s3,24(a0)
 84c:	02053a03          	ld	s4,32(a0)
 850:	02853a83          	ld	s5,40(a0)
 854:	03053b03          	ld	s6,48(a0)
 858:	03853b83          	ld	s7,56(a0)
 85c:	04053c03          	ld	s8,64(a0)
 860:	04853c83          	ld	s9,72(a0)
 864:	05053d03          	ld	s10,80(a0)
 868:	05853d83          	ld	s11,88(a0)
 86c:	06053083          	ld	ra,96(a0)
 870:	06853103          	ld	sp,104(a0)
 874:	c199                	beqz	a1,87a <longjmp_1>
 876:	852e                	mv	a0,a1
 878:	8082                	ret

000000000000087a <longjmp_1>:
 87a:	4505                	li	a0,1
 87c:	8082                	ret
