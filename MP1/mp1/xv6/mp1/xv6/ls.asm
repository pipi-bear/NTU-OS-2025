...
fmtname(char *path)
{
  ...
  6a:	b1298993          	addi	s3,s3,-1262 # b78 <buf.1107>
...
ls(char *path)
{
 ...
 128:	9ec50513          	addi	a0,a0,-1556 # b10 <longjmp_1+0x3a>
 ...
 166:	97e58593          	addi	a1,a1,-1666 # ae0 <longjmp_1+0xa>
 16a:	4509                	li	a0,2
 ...
 17c:	98058593          	addi	a1,a1,-1664 # af8 <longjmp_1+0x22>
 180:	4509                	li	a0,2
 ...
 1ae:	97650513          	addi	a0,a0,-1674 # b20 <longjmp_1+0x4a>
 ...
 1f4:	948a0a13          	addi	s4,s4,-1720 # b38 <longjmp_1+0x62>
        printf("ls: cannot stat %s\n", buf);
 1f8:	00001a97          	auipc	s5,0x1
 1fc:	900a8a93          	addi	s5,s5,-1792 # af8 <longjmp_1+0x22>
...
main(int argc, char *argv[])
{
 ...
 2be:	88e50513          	addi	a0,a0,-1906 # b48 <longjmp_1+0x72>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 632:	52a50513          	addi	a0,a0,1322 # b58 <digits>
 636:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fe:	45eb8b93          	addi	s7,s7,1118 # b58 <digits>
 ...
 83e:	31690913          	addi	s2,s2,790 # b50 <longjmp_1+0x7a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 906:	26e7b783          	ld	a5,622(a5) # b70 <freep>
 ...
 934:	00e6ea63          	bltu	a3,a4,948 <free+0x50>
{
 ...
 976:	1ef73f23          	sd	a5,510(a4) # b70 <freep>
}
 97a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9a8:	1cc53503          	ld	a0,460(a0) # b70 <freep>
 ...
 9d0:	1a490913          	addi	s2,s2,420 # b70 <freep>
  if(p == (char*)-1)
 9d4:	5afd                	li	s5,-1
 9d6:	a88d                	j	a48 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9d8:	00000797          	auipc	a5,0x0
 9dc:	1b078793          	addi	a5,a5,432 # b88 <base>
 9e0:	00000717          	auipc	a4,0x0
 9e4:	18f73823          	sd	a5,400(a4) # b70 <freep>
 9e8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a0a:	16a73523          	sd	a0,362(a4) # b70 <freep>
      return (void*)(p + 1);
...
0000000000000a64 <setjmp>:
 a64:	e100                	sd	s0,0(a0)
 a66:	e504                	sd	s1,8(a0)
 a68:	01253823          	sd	s2,16(a0)
 a6c:	01353c23          	sd	s3,24(a0)
 a70:	03453023          	sd	s4,32(a0)
 a74:	03553423          	sd	s5,40(a0)
 a78:	03653823          	sd	s6,48(a0)
 a7c:	03753c23          	sd	s7,56(a0)
 a80:	05853023          	sd	s8,64(a0)
 a84:	05953423          	sd	s9,72(a0)
 a88:	05a53823          	sd	s10,80(a0)
 a8c:	05b53c23          	sd	s11,88(a0)
 a90:	06153023          	sd	ra,96(a0)
 a94:	06253423          	sd	sp,104(a0)
 a98:	4501                	li	a0,0
 a9a:	8082                	ret

0000000000000a9c <longjmp>:
 a9c:	6100                	ld	s0,0(a0)
 a9e:	6504                	ld	s1,8(a0)
 aa0:	01053903          	ld	s2,16(a0)
 aa4:	01853983          	ld	s3,24(a0)
 aa8:	02053a03          	ld	s4,32(a0)
 aac:	02853a83          	ld	s5,40(a0)
 ab0:	03053b03          	ld	s6,48(a0)
 ab4:	03853b83          	ld	s7,56(a0)
 ab8:	04053c03          	ld	s8,64(a0)
 abc:	04853c83          	ld	s9,72(a0)
 ac0:	05053d03          	ld	s10,80(a0)
 ac4:	05853d83          	ld	s11,88(a0)
 ac8:	06053083          	ld	ra,96(a0)
 acc:	06853103          	ld	sp,104(a0)
 ad0:	c199                	beqz	a1,ad6 <longjmp_1>
 ad2:	852e                	mv	a0,a1
 ad4:	8082                	ret

0000000000000ad6 <longjmp_1>:
 ad6:	4505                	li	a0,1
 ad8:	8082                	ret
