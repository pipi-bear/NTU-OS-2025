...
main(int argc, char **argv)
{
  ...
  4c:	82858593          	addi	a1,a1,-2008 # 870 <longjmp_1+0xa>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	406b8b93          	addi	s7,s7,1030 # 890 <digits>
 ...
 5ce:	2be90913          	addi	s2,s2,702 # 888 <longjmp_1+0x22>
        while(*s != 0){
...
free(void *ap)
{
 ...
 696:	2167b783          	ld	a5,534(a5) # 8a8 <freep>
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x50>
{
 ...
 706:	1af73323          	sd	a5,422(a4) # 8a8 <freep>
}
 70a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 738:	17453503          	ld	a0,372(a0) # 8a8 <freep>
 ...
 760:	14c90913          	addi	s2,s2,332 # 8a8 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 766:	a88d                	j	7d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 768:	00000797          	auipc	a5,0x0
 76c:	14878793          	addi	a5,a5,328 # 8b0 <base>
 770:	00000717          	auipc	a4,0x0
 774:	12f73c23          	sd	a5,312(a4) # 8a8 <freep>
 778:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79a:	10a73923          	sd	a0,274(a4) # 8a8 <freep>
      return (void*)(p + 1);
...
00000000000007f4 <setjmp>:
 7f4:	e100                	sd	s0,0(a0)
 7f6:	e504                	sd	s1,8(a0)
 7f8:	01253823          	sd	s2,16(a0)
 7fc:	01353c23          	sd	s3,24(a0)
 800:	03453023          	sd	s4,32(a0)
 804:	03553423          	sd	s5,40(a0)
 808:	03653823          	sd	s6,48(a0)
 80c:	03753c23          	sd	s7,56(a0)
 810:	05853023          	sd	s8,64(a0)
 814:	05953423          	sd	s9,72(a0)
 818:	05a53823          	sd	s10,80(a0)
 81c:	05b53c23          	sd	s11,88(a0)
 820:	06153023          	sd	ra,96(a0)
 824:	06253423          	sd	sp,104(a0)
 828:	4501                	li	a0,0
 82a:	8082                	ret

000000000000082c <longjmp>:
 82c:	6100                	ld	s0,0(a0)
 82e:	6504                	ld	s1,8(a0)
 830:	01053903          	ld	s2,16(a0)
 834:	01853983          	ld	s3,24(a0)
 838:	02053a03          	ld	s4,32(a0)
 83c:	02853a83          	ld	s5,40(a0)
 840:	03053b03          	ld	s6,48(a0)
 844:	03853b83          	ld	s7,56(a0)
 848:	04053c03          	ld	s8,64(a0)
 84c:	04853c83          	ld	s9,72(a0)
 850:	05053d03          	ld	s10,80(a0)
 854:	05853d83          	ld	s11,88(a0)
 858:	06053083          	ld	ra,96(a0)
 85c:	06853103          	ld	sp,104(a0)
 860:	c199                	beqz	a1,866 <longjmp_1>
 862:	852e                	mv	a0,a1
 864:	8082                	ret

0000000000000866 <longjmp_1>:
 866:	4505                	li	a0,1
 868:	8082                	ret
