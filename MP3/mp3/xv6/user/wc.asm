...
wc(int fd, char *name)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    for(i=0; i<n; i++){
      ...
      40:	50470713          	addi	a4,a4,1284 # 1540 <buf>
      ...
      64:	4e070713          	addi	a4,a4,1248 # 1540 <buf>
      68:	fec42783          	lw	a5,-20(s0)
      6c:	97ba                	add	a5,a5,a4
      6e:	0007c783          	lbu	a5,0(a5)
      72:	85be                	mv	a1,a5
      74:	00001517          	auipc	a0,0x1
      78:	46450513          	addi	a0,a0,1124 # 14d8 <schedule_edf_cbs+0x410>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
      ...
      cc:	47858593          	addi	a1,a1,1144 # 1540 <buf>
      d0:	853e                	mv	a0,a5
  ...
  if(n < 0){
    ...
    printf("wc: read error\n");
      ...
      f8:	3ec50513          	addi	a0,a0,1004 # 14e0 <schedule_edf_cbs+0x418>
  ...
  printf("%d %d %d %s\n", l, w, c, name);
     ...
     124:	3d050513          	addi	a0,a0,976 # 14f0 <schedule_edf_cbs+0x428>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    wc(0, "");
     ...
     15e:	3a658593          	addi	a1,a1,934 # 1500 <schedule_edf_cbs+0x438>
     162:	4501                	li	a0,0
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1bc:	35050513          	addi	a0,a0,848 # 1508 <schedule_edf_cbs+0x440>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     81a:	d1268693          	addi	a3,a3,-750 # 1528 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     8f4:	c3870713          	addi	a4,a4,-968 # 1528 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ab4:	a7078793          	addi	a5,a5,-1424 # 1520 <schedule_edf_cbs+0x458>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     c60:	af478793          	addi	a5,a5,-1292 # 1750 <freep>
     c64:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     d58:	9fc78793          	addi	a5,a5,-1540 # 1750 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     dda:	97a78793          	addi	a5,a5,-1670 # 1750 <freep>
     dde:	639c                	ld	a5,0(a5)
}
     de0:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     e0c:	94878793          	addi	a5,a5,-1720 # 1750 <freep>
     e10:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     e20:	92478793          	addi	a5,a5,-1756 # 1740 <base>
     e24:	fef43023          	sd	a5,-32(s0)
     e28:	00001797          	auipc	a5,0x1
     e2c:	92878793          	addi	a5,a5,-1752 # 1750 <freep>
     e30:	fe043703          	ld	a4,-32(s0)
     e34:	e398                	sd	a4,0(a5)
     e36:	00001797          	auipc	a5,0x1
     e3a:	91a78793          	addi	a5,a5,-1766 # 1750 <freep>
     e3e:	6398                	ld	a4,0(a5)
     e40:	00001797          	auipc	a5,0x1
     e44:	90078793          	addi	a5,a5,-1792 # 1740 <base>
     e48:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     e4a:	00001797          	auipc	a5,0x1
     e4e:	8f678793          	addi	a5,a5,-1802 # 1740 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     eca:	88a78793          	addi	a5,a5,-1910 # 1750 <freep>
    ...
    if(p == freep)
     ...
     ee0:	87478793          	addi	a5,a5,-1932 # 1750 <freep>
     ee4:	639c                	ld	a5,0(a5)
...
0000000000001038 <__edf_thread_cmp>:
...
static int __edf_thread_cmp(struct thread *a, struct thread *b)
{
    ...
    104a:	57fc                	lw	a5,108(a5)
    104c:	c799                	beqz	a5,105a <__edf_thread_cmp+0x22>
    104e:	fe043783          	ld	a5,-32(s0)
    1052:	57fc                	lw	a5,108(a5)
    1054:	e399                	bnez	a5,105a <__edf_thread_cmp+0x22>
    1056:	57fd                	li	a5,-1
    1058:	a0a5                	j	10c0 <__edf_thread_cmp+0x88>
    if (!a->cbs.is_hard_rt && b->cbs.is_hard_rt) return 1;
    105a:	fe843783          	ld	a5,-24(s0)
    105e:	57fc                	lw	a5,108(a5)
    1060:	e799                	bnez	a5,106e <__edf_thread_cmp+0x36>
    1062:	fe043783          	ld	a5,-32(s0)
    1066:	57fc                	lw	a5,108(a5)
    1068:	c399                	beqz	a5,106e <__edf_thread_cmp+0x36>
    106a:	4785                	li	a5,1
    106c:	a891                	j	10c0 <__edf_thread_cmp+0x88>
    ...
    107a:	00f75463          	bge	a4,a5,1082 <__edf_thread_cmp+0x4a>
    107e:	57fd                	li	a5,-1
    1080:	a081                	j	10c0 <__edf_thread_cmp+0x88>
    if (a->current_deadline > b->current_deadline) return 1;
    1082:	fe843783          	ld	a5,-24(s0)
    1086:	4fb8                	lw	a4,88(a5)
    1088:	fe043783          	ld	a5,-32(s0)
    108c:	4fbc                	lw	a5,88(a5)
    108e:	00e7d463          	bge	a5,a4,1096 <__edf_thread_cmp+0x5e>
    1092:	4785                	li	a5,1
    1094:	a035                	j	10c0 <__edf_thread_cmp+0x88>
    
    // Break ties using thread ID
    if (a->ID < b->ID) return -1;
    1096:	fe843783          	ld	a5,-24(s0)
    109a:	5fd8                	lw	a4,60(a5)
    109c:	fe043783          	ld	a5,-32(s0)
    10a0:	5fdc                	lw	a5,60(a5)
    10a2:	00f75463          	bge	a4,a5,10aa <__edf_thread_cmp+0x72>
    10a6:	57fd                	li	a5,-1
    10a8:	a821                	j	10c0 <__edf_thread_cmp+0x88>
    if (a->ID > b->ID) return 1;
    10aa:	fe843783          	ld	a5,-24(s0)
    10ae:	5fd8                	lw	a4,60(a5)
    10b0:	fe043783          	ld	a5,-32(s0)
    10b4:	5fdc                	lw	a5,60(a5)
    10b6:	00e7d463          	bge	a5,a4,10be <__edf_thread_cmp+0x86>
    10ba:	4785                	li	a5,1
    10bc:	a011                	j	10c0 <__edf_thread_cmp+0x88>
    
    return 0;
    10be:	4781                	li	a5,0
}
    10c0:	853e                	mv	a0,a5
    10c2:	6462                	ld	s0,24(sp)
    10c4:	6105                	addi	sp,sp,32
    10c6:	8082                	ret

00000000000010c8 <schedule_edf_cbs>:

//  EDF_CBS scheduler
struct threads_sched_result schedule_edf_cbs(struct threads_sched_args args)
{
    10c8:	7151                	addi	sp,sp,-240
    10ca:	f586                	sd	ra,232(sp)
    10cc:	f1a2                	sd	s0,224(sp)
    10ce:	eda6                	sd	s1,216(sp)
    10d0:	e9ca                	sd	s2,208(sp)
    10d2:	e5ce                	sd	s3,200(sp)
    10d4:	1980                	addi	s0,sp,240
    10d6:	84aa                	mv	s1,a0
...
start_scheduling:    // Label to reevaluate scheduling decision after replenishing
    ...
    10d8:	f0043823          	sd	zero,-240(s0)
    r.allocated_time = 0;
    10dc:	f0042c23          	sw	zero,-232(s0)
    ...
    10e8:	f9843783          	ld	a5,-104(s0)
    10ec:	fd878793          	addi	a5,a5,-40
    10f0:	fcf43423          	sd	a5,-56(s0)
    10f4:	a8b1                	j	1150 <schedule_edf_cbs+0x88>
        if (t->cbs.remaining_budget <= 0 && t->remaining_time > 0 && 
    10f6:	fc843783          	ld	a5,-56(s0)
    10fa:	57bc                	lw	a5,104(a5)
    10fc:	02f04f63          	bgtz	a5,113a <schedule_edf_cbs+0x72>
    1100:	fc843783          	ld	a5,-56(s0)
    1104:	4bfc                	lw	a5,84(a5)
    1106:	02f05a63          	blez	a5,113a <schedule_edf_cbs+0x72>
            args.current_time == t->current_deadline) {
    110a:	4098                	lw	a4,0(s1)
    110c:	fc843783          	ld	a5,-56(s0)
    1110:	4fbc                	lw	a5,88(a5)
        if (t->cbs.remaining_budget <= 0 && t->remaining_time > 0 && 
    1112:	02f71463          	bne	a4,a5,113a <schedule_edf_cbs+0x72>
            // replenish
            t->current_deadline += t->period;
    1116:	fc843783          	ld	a5,-56(s0)
    111a:	4fb8                	lw	a4,88(a5)
    111c:	fc843783          	ld	a5,-56(s0)
    1120:	47fc                	lw	a5,76(a5)
    1122:	9fb9                	addw	a5,a5,a4
    1124:	0007871b          	sext.w	a4,a5
    1128:	fc843783          	ld	a5,-56(s0)
    112c:	cfb8                	sw	a4,88(a5)
            t->cbs.remaining_budget = t->cbs.budget;
    112e:	fc843783          	ld	a5,-56(s0)
    1132:	53f8                	lw	a4,100(a5)
    1134:	fc843783          	ld	a5,-56(s0)
    1138:	d7b8                	sw	a4,104(a5)
    list_for_each_entry(t, args.run_queue, thread_list) {
    113a:	fc843783          	ld	a5,-56(s0)
    113e:	779c                	ld	a5,40(a5)
    1140:	f2f43823          	sd	a5,-208(s0)
    1144:	f3043783          	ld	a5,-208(s0)
    ...
    115a:	f8f71ee3          	bne	a4,a5,10f6 <schedule_edf_cbs+0x2e>
        }
    }
    ...
    115e:	649c                	ld	a5,8(s1)
    1160:	4098                	lw	a4,0(s1)
    1162:	85ba                	mv	a1,a4
    1164:	853e                	mv	a0,a5
    1166:	00000097          	auipc	ra,0x0
    116a:	e38080e7          	jalr	-456(ra) # f9e <__check_deadline_miss>
    116e:	f8a43823          	sd	a0,-112(s0)
    if (missed) {
    1172:	f9043783          	ld	a5,-112(s0)
    1176:	c395                	beqz	a5,119a <schedule_edf_cbs+0xd2>
        r.scheduled_thread_list_member = &missed->thread_list;
    1178:	f9043783          	ld	a5,-112(s0)
    117c:	02878793          	addi	a5,a5,40
    1180:	f0f43823          	sd	a5,-240(s0)
        r.allocated_time = 0;
    1184:	f0042c23          	sw	zero,-232(s0)
        return r;
    1188:	f1043783          	ld	a5,-240(s0)
    118c:	f2f43023          	sd	a5,-224(s0)
    1190:	f1843783          	ld	a5,-232(s0)
    1194:	f2f43423          	sd	a5,-216(s0)
    1198:	ae19                	j	14ae <schedule_edf_cbs+0x3e6>
    }

    // 3. Find the best thread according to EDF
    struct thread *selected = NULL;
    119a:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(t, args.run_queue, thread_list) {
    119e:	649c                	ld	a5,8(s1)
    ...
    11b2:	a0ad                	j	121c <schedule_edf_cbs+0x154>
        // skip finished or throttled threads
        if (t->remaining_time <= 0 || 
    11b4:	fc843783          	ld	a5,-56(s0)
    11b8:	4bfc                	lw	a5,84(a5)
    11ba:	04f05563          	blez	a5,1204 <schedule_edf_cbs+0x13c>
            (t->cbs.remaining_budget <= 0 && t->remaining_time > 0 && 
    11be:	fc843783          	ld	a5,-56(s0)
    11c2:	57bc                	lw	a5,104(a5)
        if (t->remaining_time <= 0 || 
    11c4:	00f04d63          	bgtz	a5,11de <schedule_edf_cbs+0x116>
            (t->cbs.remaining_budget <= 0 && t->remaining_time > 0 && 
    11c8:	fc843783          	ld	a5,-56(s0)
    11cc:	4bfc                	lw	a5,84(a5)
    11ce:	00f05863          	blez	a5,11de <schedule_edf_cbs+0x116>
             args.current_time < t->current_deadline))
    11d2:	4098                	lw	a4,0(s1)
    11d4:	fc843783          	ld	a5,-56(s0)
    11d8:	4fbc                	lw	a5,88(a5)
            (t->cbs.remaining_budget <= 0 && t->remaining_time > 0 && 
    11da:	02f74563          	blt	a4,a5,1204 <schedule_edf_cbs+0x13c>
            continue;

        if (!selected || __edf_thread_cmp(t, selected) < 0)
    11de:	fc043783          	ld	a5,-64(s0)
    11e2:	cf81                	beqz	a5,11fa <schedule_edf_cbs+0x132>
    11e4:	fc043583          	ld	a1,-64(s0)
    11e8:	fc843503          	ld	a0,-56(s0)
    11ec:	00000097          	auipc	ra,0x0
    11f0:	e4c080e7          	jalr	-436(ra) # 1038 <__edf_thread_cmp>
    11f4:	87aa                	mv	a5,a0
    11f6:	0007d863          	bgez	a5,1206 <schedule_edf_cbs+0x13e>
            selected = t;
    11fa:	fc843783          	ld	a5,-56(s0)
    11fe:	fcf43023          	sd	a5,-64(s0)
    1202:	a011                	j	1206 <schedule_edf_cbs+0x13e>
            continue;
    1204:	0001                	nop
    list_for_each_entry(t, args.run_queue, thread_list) {
    1206:	fc843783          	ld	a5,-56(s0)
    120a:	779c                	ld	a5,40(a5)
    120c:	f2f43c23          	sd	a5,-200(s0)
    1210:	f3843783          	ld	a5,-200(s0)
    1214:	fd878793          	addi	a5,a5,-40
    1218:	fcf43423          	sd	a5,-56(s0)
    121c:	fc843783          	ld	a5,-56(s0)
    1220:	02878713          	addi	a4,a5,40
    1224:	649c                	ld	a5,8(s1)
    1226:	f8f717e3          	bne	a4,a5,11b4 <schedule_edf_cbs+0xec>
    }

    // 4. If no valid thread is found, find the next release time
    if (!selected) {
    122a:	fc043783          	ld	a5,-64(s0)
    122e:	ebd5                	bnez	a5,12e2 <schedule_edf_cbs+0x21a>
        int next_release = INT_MAX;
    1230:	800007b7          	lui	a5,0x80000
    1234:	fff7c793          	not	a5,a5
    1238:	faf42e23          	sw	a5,-68(s0)
        struct release_queue_entry *rqe = NULL;
    123c:	fa043823          	sd	zero,-80(s0)
        list_for_each_entry(rqe, args.release_queue, thread_list) {
    1240:	689c                	ld	a5,16(s1)
    1242:	639c                	ld	a5,0(a5)
    1244:	f4f43423          	sd	a5,-184(s0)
    1248:	f4843783          	ld	a5,-184(s0)
    124c:	17e1                	addi	a5,a5,-8
    124e:	faf43823          	sd	a5,-80(s0)
    1252:	a835                	j	128e <schedule_edf_cbs+0x1c6>
            if (rqe->release_time > args.current_time && rqe->release_time < next_release) {
    1254:	fb043783          	ld	a5,-80(s0)
    1258:	4f98                	lw	a4,24(a5)
    125a:	409c                	lw	a5,0(s1)
    125c:	00e7df63          	bge	a5,a4,127a <schedule_edf_cbs+0x1b2>
    1260:	fb043783          	ld	a5,-80(s0)
    1264:	4f98                	lw	a4,24(a5)
    1266:	fbc42783          	lw	a5,-68(s0)
    126a:	2781                	sext.w	a5,a5
    126c:	00f75763          	bge	a4,a5,127a <schedule_edf_cbs+0x1b2>
                next_release = rqe->release_time;
    1270:	fb043783          	ld	a5,-80(s0)
    1274:	4f9c                	lw	a5,24(a5)
    1276:	faf42e23          	sw	a5,-68(s0)
        list_for_each_entry(rqe, args.release_queue, thread_list) {
    127a:	fb043783          	ld	a5,-80(s0)
    127e:	679c                	ld	a5,8(a5)
    1280:	f4f43023          	sd	a5,-192(s0)
    1284:	f4043783          	ld	a5,-192(s0)
    1288:	17e1                	addi	a5,a5,-8
    128a:	faf43823          	sd	a5,-80(s0)
    128e:	fb043783          	ld	a5,-80(s0)
    1292:	00878713          	addi	a4,a5,8 # ffffffff80000008 <__global_pointer$+0xffffffff7fffe2e0>
    1296:	689c                	ld	a5,16(s1)
    1298:	faf71ee3          	bne	a4,a5,1254 <schedule_edf_cbs+0x18c>
            }
        }
        
        if (next_release != INT_MAX) {
    129c:	fbc42783          	lw	a5,-68(s0)
    12a0:	0007871b          	sext.w	a4,a5
    12a4:	800007b7          	lui	a5,0x80000
    12a8:	fff7c793          	not	a5,a5
    12ac:	00f70e63          	beq	a4,a5,12c8 <schedule_edf_cbs+0x200>
            // Sleep until next release
            r.scheduled_thread_list_member = args.run_queue;
    12b0:	649c                	ld	a5,8(s1)
    12b2:	f0f43823          	sd	a5,-240(s0)
            r.allocated_time = next_release - args.current_time;
    12b6:	409c                	lw	a5,0(s1)
    12b8:	fbc42703          	lw	a4,-68(s0)
    12bc:	40f707bb          	subw	a5,a4,a5
    12c0:	2781                	sext.w	a5,a5
    12c2:	f0f42c23          	sw	a5,-232(s0)
    12c6:	a029                	j	12d0 <schedule_edf_cbs+0x208>
        } else {
            // No future releases
            r.scheduled_thread_list_member = NULL;
    12c8:	f0043823          	sd	zero,-240(s0)
            r.allocated_time = 0;
    12cc:	f0042c23          	sw	zero,-232(s0)
        }
        return r;
    12d0:	f1043783          	ld	a5,-240(s0)
    12d4:	f2f43023          	sd	a5,-224(s0)
    12d8:	f1843783          	ld	a5,-232(s0)
    12dc:	f2f43423          	sd	a5,-216(s0)
    12e0:	a2f9                	j	14ae <schedule_edf_cbs+0x3e6>
    }

    // 5. CBS admission control (for soft real-time tasks only)
    if (!selected->cbs.is_hard_rt) {
    12e2:	fc043783          	ld	a5,-64(s0)
    12e6:	57fc                	lw	a5,108(a5)
    12e8:	e7f1                	bnez	a5,13b4 <schedule_edf_cbs+0x2ec>
        int remaining_budget = selected->cbs.remaining_budget;
    12ea:	fc043783          	ld	a5,-64(s0)
    12ee:	57bc                	lw	a5,104(a5)
    12f0:	f4f42e23          	sw	a5,-164(s0)
        int time_until_deadline = selected->current_deadline - args.current_time;
    12f4:	fc043783          	ld	a5,-64(s0)
    12f8:	4fb8                	lw	a4,88(a5)
    12fa:	409c                	lw	a5,0(s1)
    12fc:	40f707bb          	subw	a5,a4,a5
    1300:	f4f42c23          	sw	a5,-168(s0)
        int scaled_left = remaining_budget * selected->period;
    1304:	fc043783          	ld	a5,-64(s0)
    1308:	47fc                	lw	a5,76(a5)
    130a:	f5c42703          	lw	a4,-164(s0)
    130e:	02f707bb          	mulw	a5,a4,a5
    1312:	f4f42a23          	sw	a5,-172(s0)
        int scaled_right = selected->cbs.budget * time_until_deadline;
    1316:	fc043783          	ld	a5,-64(s0)
    131a:	53fc                	lw	a5,100(a5)
    131c:	f5842703          	lw	a4,-168(s0)
    1320:	02f707bb          	mulw	a5,a4,a5
    1324:	f4f42823          	sw	a5,-176(s0)

        if (scaled_left > scaled_right) {
    1328:	f5442703          	lw	a4,-172(s0)
    132c:	f5042783          	lw	a5,-176(s0)
    1330:	2701                	sext.w	a4,a4
    1332:	2781                	sext.w	a5,a5
    1334:	02e7d363          	bge	a5,a4,135a <schedule_edf_cbs+0x292>
    ...
    135e:	57bc                	lw	a5,104(a5)
    1360:	02f04063          	bgtz	a5,1380 <schedule_edf_cbs+0x2b8>
    1364:	fc043783          	ld	a5,-64(s0)
    1368:	4bfc                	lw	a5,84(a5)
    136a:	00f05b63          	blez	a5,1380 <schedule_edf_cbs+0x2b8>
            r.scheduled_thread_list_member = &selected->thread_list;
    136e:	fc043783          	ld	a5,-64(s0)
    1372:	02878793          	addi	a5,a5,40 # ffffffff80000028 <__global_pointer$+0xffffffff7fffe300>
    1376:	f0f43823          	sd	a5,-240(s0)
            r.allocated_time = 0;
    137a:	f0042c23          	sw	zero,-232(s0)
            goto start_scheduling;  // Restart scheduling decision after throttling
    137e:	bba9                	j	10d8 <schedule_edf_cbs+0x10>
        }
    ...
    1388:	f0f43823          	sd	a5,-240(s0)
        r.allocated_time = (selected->remaining_time < selected->cbs.remaining_budget) 
    138c:	fc043783          	ld	a5,-64(s0)
    1390:	57b8                	lw	a4,104(a5)
    1392:	fc043783          	ld	a5,-64(s0)
    1396:	4bfc                	lw	a5,84(a5)
                          ? selected->remaining_time 
                          : selected->cbs.remaining_budget;
    1398:	863e                	mv	a2,a5
    139a:	86ba                	mv	a3,a4
    139c:	0006871b          	sext.w	a4,a3
    13a0:	0006079b          	sext.w	a5,a2
    13a4:	00e7d363          	bge	a5,a4,13aa <schedule_edf_cbs+0x2e2>
    13a8:	86b2                	mv	a3,a2
    13aa:	0006879b          	sext.w	a5,a3
        r.allocated_time = (selected->remaining_time < selected->cbs.remaining_budget) 
    13ae:	f0f42c23          	sw	a5,-232(s0)
    13b2:	a0f5                	j	149e <schedule_edf_cbs+0x3d6>
    } else {
    ...
    13b8:	4bfc                	lw	a5,84(a5)
    13ba:	faf42623          	sw	a5,-84(s0)
        struct release_queue_entry *rqe = NULL;
    13be:	fa043023          	sd	zero,-96(s0)
        
        list_for_each_entry(rqe, args.release_queue, thread_list) {
    13c2:	689c                	ld	a5,16(s1)
    13c4:	639c                	ld	a5,0(a5)
    13c6:	f8f43023          	sd	a5,-128(s0)
    13ca:	f8043783          	ld	a5,-128(s0)
    13ce:	17e1                	addi	a5,a5,-8
    13d0:	faf43023          	sd	a5,-96(s0)
    13d4:	a041                	j	1454 <schedule_edf_cbs+0x38c>
            struct thread *future = rqe->thrd;
    13d6:	fa043783          	ld	a5,-96(s0)
    13da:	639c                	ld	a5,0(a5)
    13dc:	f6f43823          	sd	a5,-144(s0)
            if (future->arrival_time > args.current_time &&
    13e0:	f7043783          	ld	a5,-144(s0)
    13e4:	53b8                	lw	a4,96(a5)
    13e6:	409c                	lw	a5,0(s1)
    13e8:	04e7dc63          	bge	a5,a4,1440 <schedule_edf_cbs+0x378>
                future->arrival_time < args.current_time + max_alloc &&
    13ec:	f7043783          	ld	a5,-144(s0)
    13f0:	53b4                	lw	a3,96(a5)
    13f2:	409c                	lw	a5,0(s1)
    13f4:	fac42703          	lw	a4,-84(s0)
    13f8:	9fb9                	addw	a5,a5,a4
    13fa:	2781                	sext.w	a5,a5
            if (future->arrival_time > args.current_time &&
    13fc:	8736                	mv	a4,a3
    13fe:	04f75163          	bge	a4,a5,1440 <schedule_edf_cbs+0x378>
                __edf_thread_cmp(future, selected) < 0) {
    1402:	fc043583          	ld	a1,-64(s0)
    1406:	f7043503          	ld	a0,-144(s0)
    140a:	00000097          	auipc	ra,0x0
    140e:	c2e080e7          	jalr	-978(ra) # 1038 <__edf_thread_cmp>
    1412:	87aa                	mv	a5,a0
                future->arrival_time < args.current_time + max_alloc &&
    1414:	0207d663          	bgez	a5,1440 <schedule_edf_cbs+0x378>
                
                // A higher priority task will arrive, need to preempt
                int safe_time = future->arrival_time - args.current_time;
    1418:	f7043783          	ld	a5,-144(s0)
    141c:	53b8                	lw	a4,96(a5)
    141e:	409c                	lw	a5,0(s1)
    1420:	40f707bb          	subw	a5,a4,a5
    1424:	f6f42623          	sw	a5,-148(s0)
                if (safe_time < max_alloc) {
    1428:	f6c42703          	lw	a4,-148(s0)
    142c:	fac42783          	lw	a5,-84(s0)
    1430:	2701                	sext.w	a4,a4
    1432:	2781                	sext.w	a5,a5
    1434:	00f75663          	bge	a4,a5,1440 <schedule_edf_cbs+0x378>
                    max_alloc = safe_time;
    1438:	f6c42783          	lw	a5,-148(s0)
    143c:	faf42623          	sw	a5,-84(s0)
        list_for_each_entry(rqe, args.release_queue, thread_list) {
    1440:	fa043783          	ld	a5,-96(s0)
    1444:	679c                	ld	a5,8(a5)
    1446:	f6f43023          	sd	a5,-160(s0)
    144a:	f6043783          	ld	a5,-160(s0)
    144e:	17e1                	addi	a5,a5,-8
    1450:	faf43023          	sd	a5,-96(s0)
    1454:	fa043783          	ld	a5,-96(s0)
    1458:	00878713          	addi	a4,a5,8
    145c:	689c                	ld	a5,16(s1)
    145e:	f6f71ce3          	bne	a4,a5,13d6 <schedule_edf_cbs+0x30e>
                }
            }
        }
    ...
    146e:	f6f42e23          	sw	a5,-132(s0)
        if (time_to_deadline < max_alloc) {
    1472:	f7c42703          	lw	a4,-132(s0)
    1476:	fac42783          	lw	a5,-84(s0)
    147a:	2701                	sext.w	a4,a4
    147c:	2781                	sext.w	a5,a5
    147e:	00f75663          	bge	a4,a5,148a <schedule_edf_cbs+0x3c2>
            max_alloc = time_to_deadline;
    1482:	f7c42783          	lw	a5,-132(s0)
    1486:	faf42623          	sw	a5,-84(s0)
        }

        r.scheduled_thread_list_member = &selected->thread_list;
    148a:	fc043783          	ld	a5,-64(s0)
    148e:	02878793          	addi	a5,a5,40
    1492:	f0f43823          	sd	a5,-240(s0)
        r.allocated_time = max_alloc;
    1496:	fac42783          	lw	a5,-84(s0)
    149a:	f0f42c23          	sw	a5,-232(s0)
    }

    return r;
    149e:	f1043783          	ld	a5,-240(s0)
    14a2:	f2f43023          	sd	a5,-224(s0)
    14a6:	f1843783          	ld	a5,-232(s0)
    14aa:	f2f43423          	sd	a5,-216(s0)
    14ae:	4701                	li	a4,0
    14b0:	f2043703          	ld	a4,-224(s0)
    14b4:	4781                	li	a5,0
    14b6:	f2843783          	ld	a5,-216(s0)
    14ba:	893a                	mv	s2,a4
    14bc:	89be                	mv	s3,a5
    14be:	874a                	mv	a4,s2
    14c0:	87ce                	mv	a5,s3
    ...
    14c2:	853a                	mv	a0,a4
    14c4:	85be                	mv	a1,a5
    14c6:	70ae                	ld	ra,232(sp)
    14c8:	740e                	ld	s0,224(sp)
    14ca:	64ee                	ld	s1,216(sp)
    14cc:	694e                	ld	s2,208(sp)
    14ce:	69ae                	ld	s3,200(sp)
    14d0:	616d                	addi	sp,sp,240
    14d2:	8082                	ret
